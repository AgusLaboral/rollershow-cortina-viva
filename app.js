...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function Md(){return new ct({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:zh(),fragmentShader:`
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function Sd(){return new ct({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zh(),fragmentShader:`
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function zh(){return`
	...
	`}function Ox(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){let l=o.mapping,c=l===vr||l===lc,h=l===Is||l===Ls;if(c||h){let u=e.get(o),d=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new $a(i)),u=c?t.fromEquirectangular(o,u):t.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),u.texture;if(u!==void 0)return u.texture;{let f=o.image;return c&&f&&f.height>0||h&&f&&s(f)?(t===null&&(t=new $a(i)),u=c?t.fromEquirectangular(o):t.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),o.addEventListener("dispose",r),u.texture):null}}}return o}function s(o){let l=0,c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function r(o){let l=o.target;l.removeEventListener("dispose",r);let c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function Bx(i){let e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){let s=t(n);return s===null&&Ha("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function zx(i,e,t,n){let s={},r=new WeakMap;function a(u){let d=u.target;d.index!==null&&e.remove(d.index);for(let g in d.attributes)e.remove(d.attributes[g]);for(let g in d.morphAttributes){let v=d.morphAttributes[g];for(let m=0,p=v.length;m<p;m++)e.remove(v[m])}d.removeEventListener("dispose",a),delete s[d.id];let f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(u,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,t.memory.geometries++),d}function l(u){let d=u.attributes;for(let g in d)e.update(d[g],i.ARRAY_BUFFER);let f=u.morphAttributes;for(let g in f){let v=f[g];for(let m=0,p=v.length;m<p;m++)e.update(v[m],i.ARRAY_BUFFER)}}function c(u){let d=[],f=u.index,g=u.attributes.position,v=0;if(f!==null){let w=f.array;v=f.version;for(let _=0,b=w.length;_<b;_+=3){let U=w[_+0],A=w[_+1],T=w[_+2];d.push(U,A,A,T,T,U)}}else if(g!==void 0){let w=g.array;v=g.version;for(let _=0,b=w.length/3-1;_<b;_+=3){let U=_+0,A=_+1,T=_+2;d.push(U,A,A,T,T,U)}}else return;let m=new(pf(d)?Ka:Ja)(d,1);m.version=v;let p=r.get(u);p&&e.remove(p),r.set(u,m)}function h(u){let d=r.get(u);if(d){let f=u.index;f!==null&&d.version<f.version&&c(u)}else c(u);return r.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function Hx(i,e,t){let n;function s(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function l(d,f){i.drawElements(n,f,r,d*a),t.update(f,n,1)}function c(d,f,g){g!==0&&(i.drawElementsInstanced(n,f,r,d*a,g),t.update(f,n,g))}function h(d,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}function u(d,f,g,v){if(g===0)return;let m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)c(d[p]/a,f[p],v[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,v,0,g);let p=0;for(let w=0;w<g;w++)p+=f[w];for(let w=0;w<v.length;w++)t.update(p,n,v[w])}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function kx(i){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Vx(i,e,t){let n=new WeakMap,s=new vt;function r(a,o,l){let c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0,d=n.get(o);if(d===void 0||d.count!==u){let W=function(){T.dispose(),n.delete(o),o.removeEventListener("dispose",W)};d!==void 0&&d.texture.dispose();let f=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,v=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],p=o.morphAttributes.normal||[],w=o.morphAttributes.color||[],_=0;f===!0&&(_=1),g===!0&&(_=2),v===!0&&(_=3);let b=o.attributes.position.count*_,U=1;b>e.maxTextureSize&&(U=Math.ceil(b/e.maxTextureSize),b=e.maxTextureSize);let A=new Float32Array(b*U*4*u),T=new Ya(A,b,U,u);T.type=un,T.needsUpdate=!0;let R=_*4;for(let x=0;x<u;x++){let M=m[x],z=p[x],B=w[x],I=b*U*4*x;for(let O=0;O<M.count;O++){let C=O*R;f===!0&&(s.fromBufferAttribute(M,O),A[I+C+0]=s.x,A[I+C+1]=s.y,A[I+C+2]=s.z,A[I+C+3]=0),g===!0&&(s.fromBufferAttribute(z,O),A[I+C+4]=s.x,A[I+C+5]=s.y,A[I+C+6]=s.z,A[I+C+7]=0),v===!0&&(s.fromBufferAttribute(B,O),A[I+C+8]=s.x,A[I+C+9]=s.y,A[I+C+10]=s.z,A[I+C+11]=B.itemSize===4?s.w:1)}}d={count:u,texture:T,size:new Q(b,U)},n.set(o,d),o.addEventListener("dispose",W)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let f=0;for(let v=0;v<c.length;v++)f+=c[v];let g=o.morphTargetsRelative?1:1-f;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function Gx(i,e,t,n){let s=new WeakMap;function r(l){let c=n.render.frame,h=l.geometry,u=e.get(l,h);if(s.get(u)!==c&&(e.update(u),s.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){let d=l.skeleton;s.get(d)!==c&&(d.update(),s.set(d,c))}return u}function a(){s=new WeakMap}function o(l){let c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}var eo=class extends Nt{constructor(e,t,n,s,r,a,o,l,c,h=As){if(h!==As&&h!==Us)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===As&&(n=Xi),n===void 0&&h===Us&&(n=Ds),super(null,s,r,a,o,l,h,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Ht,this.minFilter=l!==void 0?l:Ht,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){let t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}},vf=new Nt,bd=new eo(1,1),yf=new Ya,_f=new kc,Mf=new Qa,wd=[],Ed=[],Td=new Float32Array(16),Ad=new Float32Array(9),Rd=new Float32Array(4);function ks(i,e,t){let n=i[0];if(n<=0||n>0)return i;let s=e*t,r=wd[s];if(r===void 0&&(r=new Float32Array(s),wd[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function Rt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Ct(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function bo(i,e){let t=Ed[e];t===void 0&&(t=new Int32Array(e),Ed[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Wx(i,e){let t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Xx(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Rt(t,e))return;i.uniform2fv(this.addr,e),Ct(t,e)}}function qx(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Rt(t,e))return;i.uniform3fv(this.addr,e),Ct(t,e)}}function Yx(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Rt(t,e))return;i.uniform4fv(this.addr,e),Ct(t,e)}}function Zx(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(Rt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Ct(t,e)}else{if(Rt(t,n))return;Rd.set(n),i.uniformMatrix2fv(this.addr,!1,Rd),Ct(t,n)}}function Jx(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(Rt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Ct(t,e)}else{if(Rt(t,n))return;Ad.set(n),i.uniformMatrix3fv(this.addr,!1,Ad),Ct(t,n)}}function Kx(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(Rt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Ct(t,e)}else{if(Rt(t,n))return;Td.set(n),i.uniformMatrix4fv(this.addr,!1,Td),Ct(t,n)}}function jx(i,e){let t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Qx(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Rt(t,e))return;i.uniform2iv(this.addr,e),Ct(t,e)}}function $x(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Rt(t,e))return;i.uniform3iv(this.addr,e),Ct(t,e)}}function ev(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Rt(t,e))return;i.uniform4iv(this.addr,e),Ct(t,e)}}function tv(i,e){let t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function nv(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Rt(t,e))return;i.uniform2uiv(this.addr,e),Ct(t,e)}}function iv(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Rt(t,e))return;i.uniform3uiv(this.addr,e),Ct(t,e)}}function sv(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Rt(t,e))return;i.uniform4uiv(this.addr,e),Ct(t,e)}}function rv(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(bd.compareFunction=ff,r=bd):r=vf,t.setTexture2D(e||r,s)}function av(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||_f,s)}function ov(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Mf,s)}function lv(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||yf,s)}function cv(i){switch(i){case 5126:return Wx;case 35664:return Xx;case 35665:return qx;case 35666:return Yx;case 35674:return Zx;case 35675:return Jx;case 35676:return Kx;case 5124:case 35670:return jx;case 35667:case 35671:return Qx;case 35668:case 35672:return $x;case 35669:case 35673:return ev;case 5125:return tv;case 36294:return nv;case 36295:return iv;case 36296:return sv;case 35678:case 36198:case 36298:case 36306:case 35682:return rv;case 35679:case 36299:case 36307:return av;case 35680:case 36300:case 36308:case 36293:return ov;case 36289:case 36303:case 36311:case 36292:return lv}}function hv(i,e){i.uniform1fv(this.addr,e)}function uv(i,e){let t=ks(e,this.size,2);i.uniform2fv(this.addr,t)}function dv(i,e){let t=ks(e,this.size,3);i.uniform3fv(this.addr,t)}function fv(i,e){let t=ks(e,this.size,4);i.uniform4fv(this.addr,t)}function pv(i,e){let t=ks(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function mv(i,e){let t=ks(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function gv(i,e){let t=ks(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function xv(i,e){i.uniform1iv(this.addr,e)}function vv(i,e){i.uniform2iv(this.addr,e)}function yv(i,e){i.uniform3iv(this.addr,e)}function _v(i,e){i.uniform4iv(this.addr,e)}function Mv(i,e){i.uniform1uiv(this.addr,e)}function Sv(i,e){i.uniform2uiv(this.addr,e)}function bv(i,e){i.uniform3uiv(this.addr,e)}function wv(i,e){i.uniform4uiv(this.addr,e)}function Ev(i,e,t){let n=this.cache,s=e.length,r=bo(t,s);Rt(n,r)||(i.uniform1iv(this.addr,r),Ct(n,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||vf,r[a])}function Tv(i,e,t){let n=this.cache,s=e.length,r=bo(t,s);Rt(n,r)||(i.uniform1iv(this.addr,r),Ct(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||_f,r[a])}function Av(i,e,t){let n=this.cache,s=e.length,r=bo(t,s);Rt(n,r)||(i.uniform1iv(this.addr,r),Ct(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Mf,r[a])}function Rv(i,e,t){let n=this.cache,s=e.length,r=bo(t,s);Rt(n,r)||(i.uniform1iv(this.addr,r),Ct(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||yf,r[a])}function Cv(i){switch(i){case 5126:return hv;case 35664:return uv;case 35665:return dv;case 35666:return fv;case 35674:return pv;case 35675:return mv;case 35676:return gv;case 5124:case 35670:return xv;case 35667:case 35671:return vv;case 35668:case 35672:return yv;case 35669:case 35673:return _v;case 5125:return Mv;case 36294:return Sv;case 36295:return bv;case 36296:return wv;case 35678:case 36198:case 36298:case 36306:case 35682:return Ev;case 35679:case 36299:case 36307:return Tv;case 35680:case 36300:case 36308:case 36293:return Av;case 36289:case 36303:case 36311:case 36292:return Rv}}var Wc=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=cv(t.type)}},Xc=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Cv(t.type)}},qc=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let s=this.seq;for(let r=0,a=s.length;r!==a;++r){let o=s[r];o.setValue(e,t[o.id],n)}}},Yl=/(\w+)(\])?(\[|\.)?/g;function Cd(i,e){i.seq.push(e),i.map[e.id]=e}function Pv(i,e,t){let n=i.name,s=n.length;for(Yl.lastIndex=0;;){let r=Yl.exec(n),a=Yl.lastIndex,o=r[1],l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){Cd(t,c===void 0?new Wc(o,i,e):new Xc(o,i,e));break}else{let u=t.map[o];u===void 0&&(u=new qc(o),Cd(t,u)),t=u}}}var Cs=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){let r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);Pv(r,a,this)}}setValue(e,t,n,s){let r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){let s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){let o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){let n=[];for(let s=0,r=e.length;s!==r;++s){let a=e[s];a.id in t&&n.push(a)}return n}};function Pd(i,e,t){let n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}var Iv=37297,Lv=0;function Dv(i,e){let t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){let o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}function Uv(i){let e=qe.getPrimaries(qe.workingColorSpace),t=qe.getPrimaries(i),n;switch(e===t?n="":e===Wa&&t===Ga?n="LinearDisplayP3ToLinearSRGB":e===Ga&&t===Wa&&(n="LinearSRGBToLinearDisplayP3"),i){case On:case So:return[n,"LinearTransferOETF"];case Tt:case Bh:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Id(i,e,t){let n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";let r=/ERROR: 0:(\d+)/.exec(s);if(r){let a=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+Dv(i.getShaderSource(e),a)}else return s}function Nv(i,e){let t=Uv(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Fv(i,e){let t;switch(e){case Th:t="Linear";break;case Ah:t="Reinhard";break;case Rh:t="Cineon";break;case Ur:t="ACESFilmic";break;case Ch:t="AgX";break;case Ph:t="Neutral";break;case um:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Aa=new L;function Ov(){qe.getLuminanceCoefficients(Aa);let i=Aa.x.toFixed(4),e=Aa.y.toFixed(4),t=Aa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Bv(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(fr).join(`
`)}function zv(i){let e=[];for(let t in i){let n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Hv(i,e){let t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(e,s),a=r.name,o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function fr(i){return i!==""}function Ld(i,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Dd(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var kv=/^[ \t]*#include +<([\w\d./]+)>/gm;function Yc(i){return i.replace(kv,Gv)}var Vv=new Map;function Gv(i,e){let t=Fe[e];if(t===void 0){let n=Vv.get(e);if(n!==void 0)t=Fe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Yc(t)}var Wv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ud(i){return i.replace(Wv,Xv)}function Xv(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Nd(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function qv(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Qd?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Eh?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===ii&&(e="SHADOWMAP_TYPE_VSM"),e}function Yv(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Is:case Ls:e="ENVMAP_TYPE_CUBE";break;case Mo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Zv(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ls:e="ENVMAP_MODE_REFRACTION";break}return e}function Jv(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case $d:e="ENVMAP_BLENDING_MULTIPLY";break;case cm:e="ENVMAP_BLENDING_MIX";break;case hm:e="ENVMAP_BLENDING_ADD";break}return e}function Kv(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function jv(i,e,t,n){let s=i.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,l=qv(t),c=Yv(t),h=Zv(t),u=Jv(t),d=Kv(t),f=Bv(t),g=zv(r),v=s.createProgram(),m,p,w=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);let _=w+m+a,b=w+p+o,U=Pd(s,s.VERTEX_SHADER,_),A=Pd(s,s.FRAGMENT_SHADER,b);s.attachShader(v,U),s.attachShader(v,A),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function T(M){if(i.debug.checkShaderErrors){let z=s.getProgramInfoLog(v).trim(),B=s.getShaderInfoLog(U).trim(),I=s.getShaderInfoLog(A).trim(),O=!0,C=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(O=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,U,A);else{let Z=Id(s,U,"vertex"),G=Id(s,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Gs.BlurDirectionX=new Q(1,0);Gs.BlurDirectionY=new Q(0,1);var Af={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
...
${i.fragmentShader}`.replace("#include <map_fragment>",`#include <map_fragment>
    ...
    `)};var rl=new tt(new Rn(200,200),up);rl.rotation.x=-Math.PI/2;rl.position.set(0,0,10);rl.receiveShadow=!0;at.add(rl);var al=new tt(new ci(ji.w,.1,.065),new hi({color:3486254,roughness:.72,metalness:0}));al.position.set(0,.05,ht+.045);al.castShadow=!0;al.receiveShadow=!0;at.add(al);var E_=new zs({color:16052972,roughness:.34,metalness:0,clearcoat:.42,clearcoatRoughness:.24}),T_=new Qt({color:16773327,transparent:!0,opacity:.16,depthWrite:!1}),Ff=new hi({color:5720380,roughness:.5,metalness:.45});function A_(){let i=document.createElement("canvas");i.width=i.height=256;let e=i.getContext("2d"),t=e.createRadialGradient(128,118,20,128,128,180);t.addColorStop(0,"#fffdf6"),t.addColorStop(.5,"#ffedc9"),t.addColorStop(1,"#f7cf96"),e.fillStyle=t,e.fillRect(0,0,256,256);let n=new Os(i);return n.colorSpace=Tt,n}var R_=A_(),C_=new Qt({map:R_,toneMapped:!1}),Mu=new ct({transparent:!0,depthWrite:!1,blending:wi,side:Kt,uniforms:{uIntensity:{value:.16},uColor:{value:new Ee(1,.6,.28)},uTime:{value:0}},vertexShader:["attribute vec2 aBeamUv;","varying vec2 vBeamUv;","varying vec3 vWorld;","void main(){","  vBeamUv = aBeamUv;","  vWorld = (modelMatrix * vec4(position, 1.0)).xyz;","  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);","}"].join(`
...
`)});function P_(){let i=document.createElement("canvas");i.width=i.height=256;let e=i.getContext("2d");e.clearRect(0,0,256,256);let t=[[128,128,112,1],[92,120,78,.46],[166,104,68,.36],[144,164,82,.32]];for(let[s,r,a,o]of t){let l=e.createRadialGradient(s,r,0,s,r,a);l.addColorStop(0,`rgba(255,255,255,${o})`),l.addColorStop(.36,`rgba(255,255,255,${o*.48})`),l.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=l,e.fillRect(0,0,256,256)}let n=new Os(i);return n.colorSpace=Tt,n}var I_=P_(),Gr=new Nn;at.add(Gr);var zn=new L(-1.2,-3,7.2).normalize();function L_(){let i=document.createElement("canvas");i.width=i.height=256;let e=i.getContext("2d"),t=e.createImageData(256,256);for(let s=0;s<256;s++)for(let r=0;r<256;r++){let a=Math.abs((r+.5)/128-1),o=Math.abs((s+.5)/128-1),l=Math.max(a*.78,o),c=1-Jr(.48,1,l),h=Math.max(0,1-Math.sqrt(a*a*.28+o*o*.5)*.28),u=Math.round(255*c*h),d=(s*256+r)*4;t.data[d]=t.data[d+1]=t.data[d+2]=255,t.data[d+3]=u}e.putImageData(t,0,0);let n=new Os(i);return n.colorSpace=Tt,n}var jo=new Qt({map:L_(),color:16767408,transparent:!0,opacity:0,blending:wi,depthWrite:!1,side:Kt,toneMapped:!0}),Hn=new Nn;at.add(Hn);var zr=null,He={};function dp(){if(!He.sun)return;let i=Math.max(10,Ke*2);He.sun.shadow.camera.left=-i,He.sun.shadow.camera.right=Math.max(i,Ye.aspect*9),He.sun.shadow.camera.top=Math.max(6,Pn+1.4),He.sun.shadow.camera.bottom=-4,He.sun.shadow.camera.updateProjectionMatrix()}function Su(){for(let I of[...Hn.children])Hn.remove(I),I.geometry&&I.geometry.dispose();let i=new Cr;i.moveTo(-ji.w/2,0),i.lineTo(ji.w/2,0),i.lineTo(ji.w/2,ji.h),i.lineTo(-ji.w/2,ji.h),i.closePath();let e=new Bs;e.moveTo(-Ke/2,pt),e.lineTo(Ke/2,pt),e.lineTo(Ke/2,Pn),e.lineTo(-Ke/2,Pn),e.closePath(),i.holes.push(e),Qs.geometry.dispose(),Qs.geometry=new co(i);let t=.06,n=(I,O,C,Z,G,ie)=>{let ne=new tt(new ci(I,O,C),E_);ne.position.set(Z,G,ie),ne.castShadow=!0,Hn.add(ne)};n(Ke+t*2,t,.14,0,Pn+t/2,ht),n(Ke+t*2,t,.14,0,pt-t/2+.01,ht),n(t,Je+t*2,.14,-Ke/2-t/2,pt+Je/2,ht),n(t,Je+t*2,.14,Ke/2+t/2,pt+Je/2,ht),n(t*1.3,Je,.12,0,pt+Je/2,ht);let s=t*.5,r=Math.max(2,Math.round(Je/.65));for(let I of[-1,1]){let O=I*Ke/4;n(s,Je,.09,O,pt+Je/2,ht);for(let C=1;C<r;C++)n(Ke/2-t,s,.09,O,pt+Je/r*C,ht)}zr=new tt(new Rn(Ke-.02,Je-.02),T_),zr.renderOrder=1,zr.position.set(0,pt+Je/2,ht+.012),Hn.add(zr);let a=new tt(new Rn(Math.max(9,Ke*3),Math.max(7,Je*2.5)),C_);a.position.set(0,pt+Je/2,ht-1.3),Hn.add(a);let o=Ke*1.24,l=new tt(new Rr(.016,.016,o,24),Ff);l.rotation.z=Math.PI/2,l.position.set(0,In-.24,ht),l.castShadow=!0,Hn.add(l),He.rodParts=[l];for(let I of[-o*.5,o*.5]){let O=new tt(new ho(.032,16,16),Ff);O.position.set(I,In-.24,ht),Hn.add(O),He.rodParts.push(O)}let c=(I,O,C)=>{let Z=O/-zn.y;return[I+zn.x*Z,.001,C+zn.z*Z]},h=Ke*.58,u=Math.max(.002,pt-Je*.035),d=[-h,Pn+Je*.035,ht+.02],f=[h,Pn+Je*.035,ht+.02],g=[-h,u,ht+.02],v=[h,u,ht+.02],m=c(d[0],d[1],d[2]),p=c(f[0],f[1],f[2]),w=new kt,_=[].concat(d,f,g,v,m,p);w.setAttribute("position",new Ut(new Float32Array(_),3)),w.setAttribute("aBeamUv",new Ut(new Float32Array([0,0,1,0,0,.12,1,.12,0,1,1,1]),2)),w.setIndex([0,1,5,0,5,4,2,3,5,2,5,4]);let b=new tt(w,Mu);Hn.add(b),He.shaft=b;let U=(I,O)=>{let C=O/Math.max(.001,-zn.y);return[I+zn.x*C,.004,ht+.03+zn.z*C]},A=U(-Ke/2,pt),T=U(Ke/2,pt),R=U(Ke/2,Pn),W=U(-Ke/2,Pn);He.beamEndWorld||(He.beamEndWorld=new L),He.beamEndWorld.set((W[0]+R[0])*.5,.004,(W[2]+R[2])*.5);let x=new kt;x.setAttribute("position",new Ut(new Float32Array([...A,...T,...R,...W]),3)),x.setAttribute("uv",new Ut(new Float32Array([0,0,1,0,1,1,0,1]),2)),x.setIndex([0,1,2,0,2,3]),x.computeVertexNormals();let M=new tt(x,jo);M.renderOrder=2,Hn.add(M),He.transmittedPool=M;for(let I of[...Gr.children])I.material.dispose();Gr.clear();let z=0,B=(pt+Je*.55)/Math.max(.001,-zn.y);for(let I=0;I<z;I++){let O=Math.pow((I+.35)/z,1.35),C=B*O,Z=new Er({map:I_,color:16758888,transparent:!0,opacity:0,depthWrite:!1,blending:wi,toneMapped:!1}),G=new so(Z),ie=Math.sin(I*2.17)*Ke*(.08+O*.18),ne=Math.cos(I*1.37)*Je*.045,he=Math.sin(I*.91)*(.035+O*.11),be=zn.x*C+ie,Re=pt+Je*.55+zn.y*C+ne,q=ht+.08+zn.z*C+he;G.position.set(be,Re,q),G.scale.set(Ke*(.34+O*.58),Je*(.14+O*.27),1),G.material.rotation=I%5*.37,G.userData={baseX:be,baseY:Re,baseZ:q,phase:I*1.73,p:O,density:.72+.28*Math.sin(I*3.11),baseScaleX:Ke*(.34+O*.58),baseScaleY:Je*(.14+O*.27)},Gr.add(G)}He.sun&&(He.sun.target.position.set(-Ke*.2,.05,1.6),dp()),He.glowPlane&&(He.glowPlane.scale.set(Ke+.08,Je+.08,1),He.glowPlane.position.set(0,pt+Je/2,ht-.02)),He.lightWorldPos&&He.lightWorldPos.set(0,pt+Je/2,ht)}op(120,150);Su();var fp=18,Gt=new xo(16768949,fp);Gt.position.set(.75,3,ht-3);Gt.target.position.set(-.45,0,2);Gt.castShadow=!0;Gt.shadow.mapSize.set(di.shadow,di.shadow);Gt.shadow.camera.near=.5;Gt.shadow.camera.far=30;Gt.shadow.camera.left=-4;Gt.shadow.camera.right=4;Gt.shadow.camera.top=4;Gt.shadow.camera.bottom=-4;Gt.shadow.bias=-4e-4;Gt.shadow.normalBias=.018;Gt.shadow.radius=It==="full"?2:1;at.add(Gt,Gt.target);He.sun=Gt;var D_=new vo(14148338,.2);at.add(D_);Su();var Xn=[{name:"Blackout",color:"Blanco",tex:"img/fabric/blackout-albedo.jpg",normal:"img/fabric/blackout-nor.webp",stiffness:.91,gravity:7.8,friction:.977,influence:.7,dragCap:.075,dragResponse:.82,pleatDepth:.095,compressionDepth:.035,roughness:.92,opacity:1,frostMix:0,frostLod:0,weaveStrength:0,foldShade:.34,backfaceCap:.18,castShadow:!0,shadowBlock:1,tint:16777215,sunFactor:0,backlight:0,radianceCap:.34,normalScale:.14,repeat:1.6},{name:"Gasa",color:"Beige",tex:"img/fabric/gasa.jpg",normal:"img/fabric/gasa-nor.webp",stiffness:.87,gravity:6.2,friction:.972,influence:.6,dragCap:.075,dragResponse:.9,pleatDepth:.075,compressionDepth:.08,roughness:.88,opacity:1,frostMix:.79,frostLod:Zs?3.05:3.75,weaveStrength:.64,foldShade:.14,backfaceCap:1,castShadow:!0,shadowBlock:.14,tint:16776181,sunFactor:.88,backlight:0,radianceCap:.64,normalScale:.17,repeat:2.35},{name:"Tusor",color:"Natural",tex:"img/fabric/tusor-albedo.jpg",normal:"img/fabric/tusor-nor.webp",stiffness:.9,gravity:6.9,friction:.975,influence:.56,dragCap:.066,dragResponse:.72,pleatDepth:.09,compressionDepth:.065,roughness:.92,opacity:1,frostMix:.42,frostLod:4.65,weaveStrength:.68,foldShade:.26,backfaceCap:.72,castShadow:!0,shadowBlock:.64,tint:16775405,sunFactor:.38,backlight:0,radianceCap:.45,normalScale:.24,repeat:2.05}],Xh=16773599,ns=[{...Xn[0],name:"Blackout",color:"Blanco c\xE1lido",rollerTexture:"blackout",frostMix:0,frostLod:0,weaveStrength:.42,foldShade:.12,backfaceCap:.2,shadowBlock:1,tint:Xh,sunFactor:0,radianceCap:.36,normalScale:.1,repeat:3.2,roughness:.93},{...Xn[1],name:"Screen",color:"Blanco c\xE1lido",rollerTexture:"screen",frostMix:.82,frostLod:.72,weaveStrength:.38,foldShade:.06,backfaceCap:.92,shadowBlock:.2,tint:Xh,sunFactor:.82,radianceCap:.61,normalScale:.16,repeat:4.2,roughness:.9},{...Xn[2],name:"Decorativa",color:"Blanco c\xE1lido",rollerTexture:"decorative",frostMix:.74,frostLod:5.9,weaveStrength:.32,foldShade:.1,backfaceCap:.68,shadowBlock:.56,tint:Xh,sunFactor:.46,radianceCap:.5,normalScale:.18,repeat:3.4,roughness:.94}],tr=1,Li=Xn[tr],bu={traditional:[{name:"Blackout",color:"Blanco",optics:"Sin paso",telaId:2009},{name:"Gasa",color:"Beige",optics:"Paso alto",telaId:1999},{name:"Tusor",color:"Natural",optics:"Paso medio",telaId:2006}],roller:[{name:"Blackout",color:"Blanco c\xE1lido",optics:"Sin paso",telaId:1746},{name:"Screen",color:"Blanco c\xE1lido",optics:"Paso alto",telaId:1756},{name:"Decorativa",color:"Blanco c\xE1lido",optics:"Paso medio",telaId:1585}]},ta=()=>je==="roller"?"roller":"traditional",jr=()=>bu[ta()][qn];function na(){let i=ta(),e=bu[i];Zr.forEach(t=>{let n=Number(t.dataset.product),s=e[n];t.querySelector("b").textContent=s.name,t.querySelector("small").textContent=s.optics,t.setAttribute("aria-pressed",String(n===qn)),t.setAttribute("aria-label",`${s.name}: ${s.optics}`)})}function ol(){let i=jr();Zf.textContent=i.name,Jf.textContent=i.color}var ia=new yt(512,288,{minFilter:An,magFilter:dt,depthBuffer:!0});ia.texture.colorSpace=Tt;ia.texture.generateMipmaps=!0;var pp=new Q(1,1),mp=new Q(1/512,1/288),U_=new Dr,qh=new Map,gp=[];function Qo(i,e,t,n){let s=`${i}|${e}|${t}|${n??t}`;if(qh.has(s))return qh.get(s);let r,a=new Promise(l=>{r=l}),o=U_.load(i,r,void 0,r);return(i===Li.tex||i===Li.normal)&&gp.push(a),o.wrapS=o.wrapT=Ei,o.repeat.set(t,n??t),o.anisotropy=Math.min(Se.capabilities.getMaxAnisotropy(),It==="full"?8:2),e&&(o.colorSpace=Tt),qh.set(s,o),o}var Yh=new Map,Zh=new Map,xp=256,Uo=i=>Math.max(0,Math.min(255,Math.round(i)));function N_(i){if(Zh.has(i))return Zh.get(i);let e=xp,t=new Float32Array(e*e),n=new Float32Array(e*e),s=Math.PI*2;for(let a=0;a<e;a++)for(let o=0;o<e;o++){let l=a*e+o,c=o/e,h=a/e,u=Math.sin(s*(c*31+h*17))*.5+Math.sin(s*(c*53-h*29))*.25;if(i==="screen"){let f=Math.min(o%10,10-o%10),g=Math.min(a%10,10-a%10),v=Math.exp(-(f*f)/3.1),m=Math.exp(-(g*g)/3.1),p=Math.max(v,m),w=v*m;t[l]=.08+p*.7+w*.18,n[l]=-.045+p*.06+w*.012+u*.008}else if(i==="decorative"){let d=Math.pow(.5+.5*Math.cos(s*c*24),4),f=Math.pow(.5+.5*Math.cos(s*h*18),5),g=Math.sin(s*(h*5+Math.sin(s*c*3)*.18));t[l]=.25+Math.max(d*.72,f*.62)+g*.035,n[l]=d*.026+f*.022+g*.018+u*.009}else{let d=Math.sin(s*c*42),f=Math.sin(s*h*46);t[l]=.5+d*.12+f*.1+u*.035,n[l]=d*.012+f*.01+u*.006}}let r={height:t,shade:n};return Zh.set(i,r),r}function Of(i,e,t,n){let s=`${i}|${e?"normal":"albedo"}|${t}|${n??t}`;if(Yh.has(s))return Yh.get(s);let r=xp,{height:a,shade:o}=N_(i),l=new Uint8Array(r*r*4);for(let h=0;h<r;h++)for(let u=0;u<r;u++){let d=h*r+u,f=d*4;if(e){let g=a[h*r+(u-1+r)%r],v=a[h*r+(u+1)%r],m=a[(h-1+r)%r*r+u],p=a[(h+1)%r*r+u],w=(g-v)*1.55,_=(m-p)*1.55,b=1/Math.hypot(w,_,1);l[f]=Uo((w*b*.5+.5)*255),l[f+1]=Uo((_*b*.5+.5)*255),l[f+2]=Uo((b*.5+.5)*255)}else{let g=Uo(222+o[d]*255);l[f]=g,l[f+1]=g,l[f+2]=g}l[f+3]=255}let c=new Tr(l,r,r,dn);return c.wrapS=c.wrapT=Ei,c.repeat.set(t,n??t),c.generateMipmaps=!0,c.minFilter=An,c.magFilter=dt,c.anisotropy=Math.min(Se.capabilities.getMaxAnisotropy(),It==="full"?8:2),e||(c.colorSpace=Tt),c.needsUpdate=!0,Yh.set(s,c),c}function vp(i,e=.55,t=1){return{color:Of(i.rollerTexture,!1,i.repeat*e,i.repeat*t),normal:Of(i.rollerTexture,!0,i.repeat*e,i.repeat*t)}}function ou(i,e=null){let t=e?.color??Qo(i.tex,!0,i.repeat*.55,i.repeat),n=new hi({map:t,alphaMap:null,alphaTest:0,alphaHash:!1,normalMap:e?.normal??Qo(i.normal,!1,i.repeat*.55,i.repeat),normalScale:new Q(i.normalScale||.2,i.normalScale||.2),color:i.tint,emissive:0,emissiveIntensity:0,roughness:i.roughness,metalness:0,transparent:!1,opacity:1,side:Kt});return n.userData.shadowBlock=i.shadowBlock,n.onBeforeCompile=s=>{s.uniforms.uClothRadianceCap={value:i.radianceCap},s.uniforms.uClothBackdrop={value:ia.texture},s.uniforms.uClothViewport={value:pp},s.uniforms.uClothTexel={value:mp},s.uniforms.uFrostMix={value:i.frostMix},s.uniforms.uFrostLod={value:i.frostLod},s.uniforms.uWeaveStrength={value:i.weaveStrength},s.uniforms.uBackfaceCap={value:i.backfaceCap},s.uniforms.uFoldShade={value:i.foldShade},s.uniforms.uDenseHem={value:i.denseHem||0},s.fragmentShader=`uniform float uClothRadianceCap;
...
${s.fragmentShader}`.replace("#include <opaque_fragment>",`
        ...
        #include <opaque_fragment>
      `)},n.customProgramCacheKey=()=>`cloth-frost-mip-${i.frostMix}-${i.frostLod}-${i.weaveStrength}-${i.foldShade}-${i.radianceCap}-${i.backfaceCap}-${i.denseHem||0}`,n}function $o(i){return new wr({depthPacking:Oh,side:Kt})}var Ft=It==="full"?32:18,At=It==="full"?56:30,F_=It==="full"?5:3,Qi=Ft+1,O_=60,B_=300,z_=120,H_=60,k_=260,V_=150,Yn=z_,Zn=V_,lu=Ke*1.34,wu=.015,yp=.006,_p=.1,Gn=Math.max(wu+yp,pt-_p),Ln=lu,qt=In+.035-Gn,G_=.18,cu=It==="full"?6:5,W_=.55,X_=i=>i+W_/(cu*Math.PI*2)*Math.sin(i*cu*Math.PI*2);function Bf(i){let e={side:i,points:[],constraints:[],tethers:[],restSpacingX:[],spread:1,openTargetSpread:1,openVelocity:0,openRows:new Float32Array(At+1),openRowVelocities:new Float32Array(At+1),offsetX:0,kinematic:null,relaxing:null};return e.panelRange=()=>{let t=Ln/2,n=t*(1-G_/2),s=i*t,r=i*(t-n);return{outer:s,inner:r,w:Math.abs(s-r)}},e.anchorX=t=>{let{outer:n}=e.panelRange();return e.offsetX+n+(t-n)*e.spread},e.build=()=>{e.points=[],e.constraints=[],e.tethers=[],e.restSpacingX=[],e.relaxing=null,e.openRows.fill(e.spread),e.openRowVelocities.fill(0);let{outer:t,inner:n}=e.panelRange(),s=qt/At,r=[];for(let a=0;a<=Ft;a++)r.push(t+X_(a/Ft)*(n-t));for(let a=0;a<Ft;a++)e.restSpacingX.push(Math.abs(r[a+1]-r[a]));for(let a=0;a<=At;a++)for(let o=0;o<=Ft;o++){let l=e.anchorX(r[o]),c=In+.035-a*s;e.points.push({x:l,y:c,px:l,py:c,baseX:r[o],pinned:a===0,u:o/Ft,v:a/At});let h=e.points.length-1;if(a>0&&e.tethers.push({anchor:o,point:h,maxLen:a*s}),o>0&&e.constraints.push({a:h-1,b:h,len:e.restSpacingX[o-1],axis:"x",xLen:e.restSpacingX[o-1],yLen:0}),a>0&&e.constraints.push({a:h-(Ft+1),b:h,len:s,axis:"y",xLen:0,yLen:s}),o>0&&a>0){let u=Math.hypot(e.restSpacingX[o-1],s);e.constraints.push({a:h-(Ft+2),b:h,len:u,axis:"diag",xLen:e.restSpacingX[o-1],yLen:s,factor:.42})}if(o<Ft&&a>0){let u=Math.hypot(e.restSpacingX[o],s);e.constraints.push({a:h-Ft,b:h,len:u,axis:"diag",xLen:e.restSpacingX[o],yLen:s,factor:.42})}o>1&&e.constraints.push({a:h-2,b:h,len:e.restSpacingX[o-2]+e.restSpacingX[o-1],axis:"x",xLen:e.restSpacingX[o-2]+e.restSpacingX[o-1],yLen:0,factor:.13}),a>1&&e.constraints.push({a:h-2*(Ft+1),b:h,len:s*2,axis:"y",xLen:0,yLen:s*2,factor:.1})}},e.startRelax=()=>{e.relaxing={startedAt:performance.now(),from:e.points.map(t=>({x:t.x,y:t.y}))}},e.cancelRelax=()=>{e.relaxing=null},e.step=(t,n,s,r,a)=>{if(e.kinematic){let c=e.kinematic,h=qt/At,{outer:u}=e.panelRange();for(let d of e.points){let f=mt(c.t*1.18-d.v*.18,0,1),g=Kr(f),v=kn(c.from.spread,c.to.spread,g),m=kn(c.from.offsetX,c.to.offsetX,g);d.x=m+u+(d.baseX-u)*v,d.y=In+.035-d.v*At*h,d.px=d.x,d.py=d.y}return}if(je==="open"){let h=Math.exp(-13.5*t);e.openVelocity=(e.openVelocity+(e.openTargetSpread-e.spread)*82*t)*h,e.spread=mt(e.spread+e.openVelocity*t,ts,1),(e.spread===ts&&e.openVelocity<0||e.spread===1&&e.openVelocity>0)&&(e.openVelocity=0),e.openRows[0]=e.spread,e.openRowVelocities[0]=0;let u=Math.exp(-15*t);for(let g=1;g<=At;g++){let v=g/At,m=kn(88,48,v);e.openRowVelocities[g]=(e.openRowVelocities[g]+(e.spread-e.openRows[g])*m*t)*u,e.openRows[g]=mt(e.openRows[g]+e.openRowVelocities[g]*t,ts,1)}let d=qt/At,{outer:f}=e.panelRange();for(let g=0;g<=At;g++){let v=e.openRows[g];for(let m=0;m<=Ft;m++){let p=e.points[g*Qi+m];p.x=e.offsetX+f+(p.baseX-f)*v,p.y=In+.035-g*d,p.px=p.x,p.py=p.y}}return}if(e.relaxing){let c=mt((performance.now()-e.relaxing.startedAt)/520,0,1),h=Kr(c);for(let u=0;u<e.points.length;u++){let d=e.points[u],f=e.relaxing.from[u],g=e.anchorX(d.baseX),v=In+.035-d.v*qt;d.x=kn(f.x,g,h),d.y=kn(f.y,v,h),d.px=d.x,d.py=d.y}c>=1&&(e.relaxing=null);return}let o=t*t,l=.11;for(let c of e.points){if(c.pinned){c.x=e.anchorX(c.baseX),c.px=c.x;continue}let h=mt((c.x-c.px)*n.friction,-l,l),u=mt((c.y-c.py)*n.friction,-l,l);if(c.px=c.x,c.py=c.y,c.x+=h+r*o,c.y+=u-n.gravity*(1+a)*o,s&&s.active){let d=c.x-s.x,f=c.y-s.y;d*d+f*f<n.influence*n.influence&&(c.px=c.x-mt(s.x-s.px,-n.dragCap,n.dragCap)*n.dragResponse,c.py=c.y-mt(s.y-s.py,-n.dragCap,n.dragCap)*n.dragResponse)}}for(let c=0;c<F_;c++){for(let h of e.constraints){let u=e.points[h.a],d=e.points[h.b],f=d.x-u.x,g=d.y-u.y,v=je==="open"&&h.axis==="x",m=(v?Math.abs(f):Math.sqrt(f*f+g*g))||1e-4,p=h.len;je==="open"&&(p=h.axis==="x"?h.xLen*e.spread:h.axis==="diag"?Math.hypot(h.xLen*e.spread,h.yLen):h.len);let w=(p-m)/m*n.stiffness*(h.factor??1),_=u.pinned?0:1,b=d.pinned?0:1,U=_+b||1,A=f*w/U,T=v?0:g*w/U;_&&(u.x-=A*_,u.y-=T*_),b&&(d.x+=A*b,d.y+=T*b)}for(let h of e.tethers){let u=e.points[h.anchor],d=e.points[h.point],f=u.y-h.maxLen;d.y>=f||(d.py+=f-d.y,d.y=f)}}},e.build(),e}function zf(){return new Rn(1,1,Ft,At)}var Wn=null;function hu(i,e){let t=i.attributes.position,n=i.attributes.uv;for(let s=0;s<=At;s++)for(let r=0;r<=Ft;r++){let a=s*Qi+r,o=e.points[a],l=0;if(r>0&&r<Ft){let g=e.points[a-1],v=e.points[a+1],m=Math.hypot(v.x-g.x,v.y-g.y),p=e.restSpacingX[r-1]+e.restSpacingX[r];l=mt((p-m)/p,0,1)}let c=e.product,h=c?.pleatDepth??.085,u=l*(c?.compressionDepth??.08),d=Math.sin(o.u*Math.PI*2*cu)*(h+u),f=0;if(Wn?.sim===e){let g=Wn.age;if(g>=0&&g<1.35){let v=Math.hypot(o.x-Wn.x,o.y-Wn.y),m=g*.92,p=Math.exp(-Math.pow((v-m)*8.5,2)),w=Jr(.04,.18,o.v)*(1-Jr(.88,1,o.v));f=Math.sin((v-m)*28)*p*w*.012*Math.exp(-g*.72)}}t.setXYZ(a,o.x,o.y,d+f),n.setXY(a,o.u,1-o.v)}t.needsUpdate=!0,n.needsUpdate=!0,i.computeVertexNormals()}function Mp(i){let e={sims:[Bf(-1),Bf(1)],meshes:[],visible:!0};e.sims.forEach(n=>{n.product=i}),e.geos=[zf(),zf()];for(let n=0;n<2;n++){let s=new tt(e.geos[n],ou(i));s.customDepthMaterial=$o(i),s.renderOrder=3,s.position.z=js,s.receiveShadow=!0,s.frustumCulled=!1,s.layers.enable(2),at.add(s),e.meshes.push(s)}e.setVisible=n=>{e.visible=n,e.meshes.forEach(s=>{s.visible=n})},e.setCastShadow=n=>e.meshes.forEach(s=>{s.castShadow=n}),e.setMaterial=n=>e.meshes.forEach(s=>{s.material?.dispose(),s.customDepthMaterial?.alphaMap?.dispose(),s.customDepthMaterial?.dispose(),s.material=ou(n),s.customDepthMaterial=$o(n)});let t=e.setMaterial;return e.setMaterial=n=>{e.sims.forEach(s=>{s.product=n}),t(n)},e.opacity=()=>e.meshes[0].material.opacity,e}var Eu=Mp(Li),Tu=Mp(Li);Tu.setVisible(!1);Eu.setCastShadow(Li.castShadow);var qn=tr,yn=Li,Ne=Eu,Bt=Tu,Mn={from:Li,to:Li,t:1},Wr=It==="full"?40:24,el=It==="full"?32:20,Js=new Rn(1,1,Wr,el);function Sp(i){return ou({...i,denseHem:1},vp(i))}var Vt=new tt(Js,Sp(ns[tr]));Vt.customDepthMaterial=$o(ns[tr]);Vt.position.z=js;Vt.renderOrder=3;Vt.receiveShadow=!1;Vt.castShadow=!0;Vt.frustumCulled=!1;Vt.layers.enable(2);Vt.visible=!1;at.add(Vt);var nr=new Nn,$s=new tt(new Rr(1,1,1,It==="full"?40:24,1,!1),new hi({color:15920872,roughness:.72,metalness:0}));$s.castShadow=!0;nr.add($s);nr.rotation.z=Math.PI/2;nr.visible=!1;at.add(nr);var bt=new tt(new ci(1,1,1),bp(ns[tr]));bt.material.userData.shadowBlock=1;bt.castShadow=!0;bt.receiveShadow=!1;bt.renderOrder=4;bt.frustumCulled=!1;bt.layers.enable(2);bt.visible=!1;at.add(bt);var en=1,Jn=1,Ci=0,Xs=.032,uu=0,Jh=.032,q_=.0052;function Y_(i){let e=vp(i,.7,.5);return new hi({map:e.color,normalMap:e.normal,normalScale:new Q((i.normalScale||.2)*.35,(i.normalScale||.2)*.35),color:i.tint,roughness:Math.max(.94,i.roughness),metalness:0})}function bp(i){let e=new Qt({colorWrite:!1,depthWrite:!0});return e.userData.shadowBlock=1,e.userData.internalCounterweight=!0,e}function ll(){let i=Js.attributes.position,e=Js.attributes.uv,t=qt*(1-en);Xs=Math.sqrt(Jh*Jh+t*q_/Math.PI);let n=In+.067,s=n-Xs;for(let a=0;a<=el;a++){let o=a/el;for(let l=0;l<=Wr;l++){let c=l/Wr,h=a*(Wr+1)+l,u=-Math.sin(c*Math.PI)*.0025;i.setXYZ(h,(c-.5)*Ln,s-o*qt*en,u);let d=1-en+o*en;e.setXY(h,c,1-d)}}i.needsUpdate=!0,e.needsUpdate=!0,Js.computeVertexNormals(),uu=t/Math.max(.001,(Jh+Xs)*.5),$s.scale.set(Xs,Ln*1.02,Xs),$s.rotation.y=-uu,nr.position.set(0,n,js-.012);let r=s-qt*en;bt.scale.set(Ln*1.01,.04,.022),bt.position.set(0,r+.018,js-.012)}function Au(i){Vt.material?.dispose(),Vt.customDepthMaterial?.dispose(),$s.material?.dispose(),bt.material?.dispose(),Vt.material=Sp(i),Vt.customDepthMaterial=$o(i),$s.material=Y_(i),bt.material=bp(i),Vt.castShadow=!0}function Z_(i){if(je!=="roller")return;let t=2/.18,n=Math.min(i,.1),s=t*n,r=1/(1+s+.48*s*s+.235*s*s*s),a=en-Jn,o=(Ci+t*a)*n;Ci=(Ci-t*o)*r;let l=en;en=mt(Jn+(a+o)*r,.08,1),(en===.08&&Ci<0||en===1&&Ci>0)&&(Ci=0),(Math.abs(en-l)>1e-5||Math.abs(Ci)>1e-4)&&ll()}ll();var Di=new Ao(Se);Di.addPass(new Ro(at,Ye));var cl=new tt(new Rn(1,1),new Qt({color:16771524}));cl.layers.set(1);at.add(cl);He.glowPlane=cl;var tl=di.occlusion,Ru=new yt(tl,Math.round(tl*1.5)),Cu=new yt(tl,Math.round(tl*1.5),{minFilter:dt,magFilter:dt,depthBuffer:!0}),J_=new Qt({color:0}),No=new Map,$i=new Set([...Eu.meshes,...Tu.meshes,Vt,bt]),K_=new Map([...$i].map(i=>[i,new Qt({color:0,transparent:!0})])),j_=new Map([...$i].map(i=>[i,new Qt({color:16777215,transparent:!0,toneMapped:!1})])),Hf=0;function Q_(){if(Hf+=1,Hf%(It==="full"?2:3)!==0)return;let e=new Map([...$i].map(s=>[s,s.visible]));$i.forEach(s=>{s.visible=!1});let t=Se.getRenderTarget(),n=Se.shadowMap.autoUpdate;Se.shadowMap.autoUpdate=!1,Se.setRenderTarget(ia),Se.clear(!0,!0,!0),Se.render(at,Ye),Se.setRenderTarget(t),Se.shadowMap.autoUpdate=n,e.forEach((s,r)=>{r.visible=s})}function $_(){let i=Se.getRenderTarget(),e=at.background,t=Se.autoClear,n=Se.shadowMap.enabled;at.background=null,Se.autoClear=!1,Se.shadowMap.enabled=!1,Se.setRenderTarget(Ru),Se.setClearColor(0,1),Se.clear(!0,!0,!0),Ye.layers.disableAll(),Ye.layers.enable(1),Se.render(at,Ye),Se.clearDepth(),No.clear(),at.traverse(s=>{if(!(!s.isMesh||s===cl||s===zr||s===He.shaft||s===He.transmittedPool))if(No.set(s,s.material),$i.has(s)){let r=K_.get(s);r.opacity=s.material.userData.shadowBlock??s.material.opacity,s.material=r}else s.material=J_}),Ye.layers.disableAll(),Ye.layers.enable(0),Se.render(at,Ye),No.forEach((s,r)=>{r.material=s}),Se.setRenderTarget(Cu),Se.setClearColor(0,1),Se.clear(!0,!0,!0);for(let s of $i){let r=s.material,a=j_.get(s);a.opacity=r.userData.shadowBlock??1,s.material=a}Ye.layers.disableAll(),Ye.layers.enable(2),Se.render(at,Ye);for(let s of $i)s.material=No.get(s)??s.material;Ye.layers.disableAll(),Ye.layers.enable(0),Se.autoClear=t,Se.shadowMap.enabled=n,at.background=e,Se.setRenderTarget(i)}var eM=`
  uniform sampler2D tDiffuse;
...
`,Qr=new Vs({uniforms:{tDiffuse:{value:null},tOcclusion:{value:Ru.texture},tClothMask:{value:Cu.texture},lightPos:{value:new Q(.5,.5)},beamEnd:{value:new Q(.5,.1)},exposure:{value:.5},decay:{value:.975},density:{value:.62},weight:{value:.36},strength:{value:1},time:{value:0},tint:{value:new L(1,.84,.66)}},vertexShader:"varying vec2 vUv; void main(){ vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position,1.0); }",fragmentShader:eM});Di.addPass(Qr);var wp=new Gs(new Q(1,1),.38,.62,.72);Di.addPass(wp);var tM=new Lo(1,1);di.smaa&&Di.addPass(tM);Di.addPass(new Co);var Ep=new L(0,pt+Je/2,ht);He.lightWorldPos=Ep;var Kh=new L,jh=new L;function nM(){Kh.copy(Ep).project(Ye),Qr.uniforms.lightPos.value.set(Kh.x*.5+.5,Kh.y*.5+.5),He.beamEndWorld&&(jh.copy(He.beamEndWorld).project(Ye),Qr.uniforms.beamEnd.value.set(jh.x*.5+.5,jh.y*.5+.5))}function iM(i){let e=0;for(let t=0;t<=At;t++){let n=t*Qi+Ft;e+=Math.max(0,i.sims[1].points[n].x-i.sims[0].points[n].x)}return mt(e/(At+1)/Math.max(Ln,.001),0,.7)}var je="fabric",Tp="fabric";function Ho(i=Ne){return je==="roller"?mt((1-en)*.7,0,.7):iM(i)}var _n=0,du=1/0;function ir(){let i=Mn.t,e=kn(Mn.from.sunFactor,Mn.to.sunFactor,i),t=ss?kn(Ho(Ne),Ho(Bt),i):Ho(Ne),n=Jr(.065,.22,t),s=Math.pow(Math.max(n,_n*.72),1.7),r=1-(1-e)*(1-s),a=(Math.exp(2.4*r)-1)/(Math.exp(2.4)-1);Gt.intensity=fp;let o=1-n*.88;jo.opacity=e*o*.2;let l=Number.isFinite(du)?Jr(0,900,performance.now()-du):0;Qr.uniforms.strength.value=a*.27*l,Mu.uniforms.uIntensity.value=0,wp.strength=.36,He.hazeStrength=a,He.sourceEnergy=r}var Ot=null,Pi=!1;function Ap(){if(Ot){!Pi&&Ot.ctx.state==="suspended"&&Ot.ctx.resume().catch(()=>{});return}if(!Pi)try{let i=new(window.AudioContext||window.webkitAudioContext),e=i.createGain();e.gain.value=0,e.connect(i.destination);let t=i.createBiquadFilter();t.type="lowpass",t.frequency.value=420,t.Q.value=.4;let n=i.createDelay(1.2);n.delayTime.value=.62;let s=i.createGain();s.gain.value=.38,n.connect(s),s.connect(n),t.connect(e),t.connect(n),n.connect(e);let r=[110,164.81,277.18,246.94],a=[.5,.34,.16,.12];r.forEach((c,h)=>{[-3,3].forEach(u=>{let d=i.createOscillator();d.type=h<2?"sine":"triangle",d.frequency.value=c,d.detune.value=u;let f=i.createGain();f.gain.value=a[h]*.5,d.connect(f),f.connect(t),d.start()})});let o=i.createOscillator();o.frequency.value=.045;let l=i.createGain();l.gain.value=90,o.connect(l),l.connect(t.frequency),o.start(),e.gain.linearRampToValueAtTime(.028,i.currentTime+3),Ot={ctx:i,master:e,filter:t,baseGain:.028,energy:0}}catch{Ot=null}}function sM(i){if(!Ot||Pi)return;Ot.energy+=(mt(i*6,0,1)-Ot.energy)*.04;let e=Ot.ctx.currentTime;Ot.filter.frequency.setTargetAtTime(420+Ot.energy*520,e,.4),Ot.master.gain.setTargetAtTime(Ot.baseGain*(1+Ot.energy*.5),e,.5)}Lf.addEventListener("click",()=>{Pi=!Pi,Lf.classList.toggle("muted",Pi),Ot?Ot.master.gain.setTargetAtTime(Pi?0:Ot.baseGain,Ot.ctx.currentTime,.3):Pi||Ap()});var kf=new _o,rM=new Tn(new L(0,0,1),-js),Qh=new Q,Vf=new L,Me={active:!1,x:0,y:0,px:0,py:0},Ii=0,es=0,ko=!1,Vo=!1,Xr=null,qr=null,aM=1.25,oM=.12;function Pu(i,e,t){_n=Math.max(_n,mt(Math.abs(t)*14,0,1))}function Vn(i,e){let t=rn.getBoundingClientRect();return Qh.x=(i-t.left)/t.width*2-1,Qh.y=-((e-t.top)/t.height)*2+1,kf.setFromCamera(Qh,Ye),kf.ray.intersectPlane(rM,Vf)?Vf:null}function Go(i,e,t=js){let n=new L(i,e,t).project(Ye),s=rn.getBoundingClientRect();return{x:(n.x*.5+.5)*s.width+s.left,y:(-n.y*.5+.5)*s.height+s.top}}var Iu="rollershow-cortina-viva:onboarding:v1:",er=new Set,fu=new Set,nl=[],St=null,Yr=0,pu=0;function Lu(i){try{return localStorage.getItem(`${Iu}${i}`)==="1"}catch{return!1}}function lM(i){try{localStorage.setItem(`${Iu}${i}`,"1")}catch{}}function Rp(){for(;nl.length;)nl.pop().cancel()}function Cp(i=!0){if(clearTimeout(pu),pu=0,Rp(),St&&i)if(St.mode==="open")for(let e of Ne.sims)e.openTargetSpread=1;else if(St.mode==="roller")Jn=1;else{Me.active=!1;for(let e of Ne.sims)e.startRelax()}Wn=null,St=null,Ys.hidden=!0}function hl(i=!0){clearTimeout(Yr),Yr=0,St&&Cp(i)}function Du(i=je){fu.has(i)||(fu.add(i),er.add(i),lM(i),hl(!1))}function ui(i,e,t){let n=i.animate(e,{fill:"both",...t});return nl.push(n),n}function cM(i,e){if(Rp(),Ys.hidden=!1,Ys.dataset.mode=i,Ys.style.setProperty("--gesture-x",`${e.x}px`),Ys.style.setProperty("--gesture-y",`${e.y}px`),ru.textContent=i==="fabric"?"Toc\xE1 y mov\xE9 la tela":i==="open"?"Desliz\xE1 para abrir":"Desliz\xE1 para subir",ui(ru,[{opacity:0,transform:"translate(-50%, 5px)"},{opacity:1,transform:"translate(-50%, 0)"},{opacity:1,transform:"translate(-50%, 0)",offset:.78},{opacity:0,transform:"translate(-50%, -3px)"}],{duration:1900,delay:i==="fabric"?780:300,easing:"cubic-bezier(.23,1,.32,1)"}),ui(v_,[{opacity:0,transform:i==="roller"?"rotate(90deg) scaleX(.25)":"scaleX(.25)"},{opacity:.78,transform:i==="roller"?"rotate(90deg) scaleX(1)":"scaleX(1)"},{opacity:0,transform:i==="roller"?"rotate(90deg) scaleX(1.12)":"scaleX(1.12)"}],{duration:1700,delay:i==="fabric"?800:360,easing:"cubic-bezier(.23,1,.32,1)"}),i==="fabric"){ui(g_,[{opacity:0,transform:"translateY(-68px) scale(.55)"},{opacity:1,offset:.18},{opacity:1,transform:"translateY(0) scale(1)",offset:.86},{opacity:0,transform:"translateY(4px) scale(.65)"}],{duration:620,delay:110,easing:"cubic-bezier(.32,0,.67,0)"});for(let[n,s,r]of[[Wh,510,2.45],[x_,650,2.05]])ui(n,[{opacity:.88,transform:"scale(.18)"},{opacity:.42,offset:.48},{opacity:0,transform:`scale(${r})`}],{duration:920,delay:s,easing:"cubic-bezier(.23,1,.32,1)"});ui(zo,[{opacity:0,transform:"translate(0,8px) scale(.92)"},{opacity:1,transform:"translate(0,0) scale(1)",offset:.18},{opacity:1,transform:"translate(62px,-5px) scale(1)",offset:.62},{opacity:.95,transform:"translate(8px,2px) scale(1)",offset:.86},{opacity:0,transform:"translate(8px,2px) scale(.96)"}],{duration:1850,delay:730,easing:"cubic-bezier(.645,.045,.355,1)"})}else i==="open"?(ui(Wh,[{opacity:0,transform:"scale(.3)"},{opacity:.72,offset:.2},{opacity:0,transform:"scale(1.45)"}],{duration:620,delay:250,easing:"cubic-bezier(.23,1,.32,1)"}),ui(zo,[{opacity:0,transform:"translate(0,5px) scale(.94)"},{opacity:1,transform:"translate(0,0) scale(1)",offset:.12},{opacity:1,transform:"translate(78px,0) scale(1)",offset:.46},{opacity:1,transform:"translate(78px,0) scale(1)",offset:.58},{opacity:1,transform:"translate(0,0) scale(1)",offset:.9},{opacity:0,transform:"translate(0,0) scale(.96)"}],{duration:2850,delay:220,easing:"cubic-bezier(.645,.045,.355,1)"})):(ui(Wh,[{opacity:0,transform:"scale(.3)"},{opacity:.72,offset:.2},{opacity:0,transform:"scale(1.45)"}],{duration:620,delay:250,easing:"cubic-bezier(.23,1,.32,1)"}),ui(zo,[{opacity:0,transform:"translate(0,8px) scale(.94)"},{opacity:1,transform:"translate(0,0) scale(1)",offset:.12},{opacity:1,transform:"translate(0,-112px) scale(1)",offset:.46},{opacity:1,transform:"translate(0,-112px) scale(1)",offset:.58},{opacity:1,transform:"translate(0,0) scale(1)",offset:.9},{opacity:0,transform:"translate(0,0) scale(.96)"}],{duration:2850,delay:220,easing:"cubic-bezier(.645,.045,.355,1)"}))}function Pp(i,e=!1){if(is||je!==i||!e&&(er.has(i)||Lu(i)))return!1;hl(),er.add(i);let t=Gn+qt*.54,n=i==="roller"?{x:0,y:Gn+qt*.36}:{x:Ln*(i==="open"?.05:.15),y:t},s=Go(n.x,n.y);return St={mode:i,startedAt:performance.now(),targetX:n.x,targetY:n.y,rippleStarted:!1},cM(i,s),pu=setTimeout(()=>Cp(!0),i==="fabric"?3300:3500),!0}function Ip(i,e=420){clearTimeout(Yr),!(er.has(i)||Lu(i))&&(Yr=setTimeout(()=>{Yr=0,Pp(i)},e))}function Lp(i){if(!St||St.mode!==je)return;let e=(i-St.startedAt)/1e3;if(St.mode==="fabric")!St.rippleStarted&&e>=.35&&(St.rippleStarted=!0,Wn={sim:Ne.sims[1],x:St.targetX,y:St.targetY,startedAt:performance.now(),age:0}),Wn&&(Wn.age=(i-Wn.startedAt)/1e3),Me.active=!1;else{let t=e<.42?0:e<1.48?Kr((e-.42)/1.06):e<1.92?1:1-Kr(mt((e-1.92)/1.08,0,1));if(St.mode==="open"){let n=kn(1,.62,t);for(let s of Ne.sims)s.openTargetSpread=n}else Jn=kn(1,.58,t);_n=Math.max(_n,t*.8)}}function ul(){Ap(),Fu()}var il=0,fn=null;function sr(){clearTimeout(il),il=0;for(let i of Ne.sims)i.cancelRelax()}function dl(){je==="fabric"&&(clearTimeout(il),il=setTimeout(()=>{Me.active=!1;for(let i of Ne.sims)i.startRelax()},1e3))}function Uu(i){if(!(!i||je==="fabric"))if(je==="open"){let e=Ne.sims[i.x<0?0:1];fn={mode:"open",sim:e,startX:i.x,startSpread:e.openTargetSpread}}else fn={mode:"roller",startY:i.y,startDrop:Jn}}function Nu(i){if(!(!i||!fn))if(fn.mode==="open"){let e=fn.sim.side*(i.x-fn.startX);fn.sim.openTargetSpread=mt(fn.startSpread-e/Math.max(.3,Ln*.38),ts,1),_n=Math.max(_n,1-fn.sim.openTargetSpread)}else Jn=mt(fn.startDrop-(i.y-fn.startY)/Math.max(.4,qt),.08,1),_n=Math.max(_n,1-Jn)}function sa(){fn=null,Me.active=!1}function $r(i){if(!["fabric","open","roller"].includes(i)||i===je||is)return;hl(!0),sr(),sa(),je=i,i!=="roller"&&(Tp=i),ep.forEach(n=>n.setAttribute("aria-pressed",String(n.dataset.mode===i)));let e=i==="roller";tp.forEach(n=>n.setAttribute("aria-pressed",String(n.dataset.family===(e?"roller":"traditional")))),Df.classList.toggle("is-roller",e),Df.hidden=e,p_.textContent=e?"C\xF3mo usarla":"C\xF3mo quer\xE9s probarla",f_.hidden=e,m_.hidden=!e,ol(),na(),Ui();for(let n of Ne.sims)n.spread=1,n.openTargetSpread=1,n.openVelocity=0,n.offsetX=0,n.build();if(Bt.setVisible(!1),Ne.setVisible(!e),Vt.visible=e,nr.visible=e,bt.visible=e,He.rodParts?.forEach(n=>{n.visible=!e}),e){en=1,Jn=1,Ci=0;let n=ns[qn];yn=n,Mn={from:n,to:n,t:1},Au(n),ll()}else{let n=Xn[qn];yn=n,Ne.setMaterial(n),Ne.setCastShadow(n.castShadow),Mn={from:n,to:n,t:1}}let t={fabric:"Mov\xE9 la tela. Vuelve a su ca\xEDda natural despu\xE9s de un segundo.",open:"Arrastr\xE1 cada pa\xF1o hacia el costado para abrirlo.",roller:"Desliz\xE1 la tela hacia arriba o abajo."};Hr.textContent=t[i],Hr.classList.remove("hidden"),clearTimeout($r.hintTimer),$r.hintTimer=setTimeout(()=>Hr.classList.add("hidden"),2200),ir(),Ip(i,520)}ep.forEach(i=>i.addEventListener("click",()=>$r(i.dataset.mode)));tp.forEach(i=>i.addEventListener("click",()=>{let e=i.dataset.family==="roller"?"roller":Tp;$r(e)}));rn.addEventListener("mouseenter",i=>{if(ul(),je!=="fabric")return;let e=Vn(i.clientX,i.clientY);e&&(sr(),Me.x=Me.px=e.x,Me.y=Me.py=e.y,Me.active=!0)});rn.addEventListener("mousedown",i=>{je!=="fabric"&&(ul(),Du(je),Uu(Vn(i.clientX,i.clientY)))});rn.addEventListener("mousemove",i=>{let e=Vn(i.clientX,i.clientY);if(je!=="fabric"){Nu(e);return}e&&(Du("fabric"),sr(),Pu(e.x,e.y,e.x-Me.x),Me.px=Me.x,Me.py=Me.y,Me.x=e.x,Me.y=e.y,Me.active=!0,dl()),Fu()});rn.addEventListener("mouseleave",()=>{Me.active=!1,je==="fabric"?dl():sa()});window.addEventListener("mouseup",sa);rn.addEventListener("touchstart",i=>{ul(),hM(),Du(je);let e=i.touches[0],t=Vn(e.clientX,e.clientY);je==="fabric"?t&&(sr(),Me.x=Me.px=t.x,Me.y=Me.py=t.y,Me.active=!0):Uu(t)},{passive:!0});rn.addEventListener("touchmove",i=>{i.preventDefault();let e=i.touches[0],t=Vn(e.clientX,e.clientY);if(je!=="fabric"){Nu(t);return}t&&(sr(),Pu(t.x,t.y,t.x-Me.x),Me.px=Me.x,Me.py=Me.y,Me.x=t.x,Me.y=t.y,Me.active=!0)},{passive:!1});var Dp=()=>{Me.active=!1,je==="fabric"?dl():sa()};rn.addEventListener("touchend",Dp);rn.addEventListener("touchcancel",Dp);window.addEventListener("resize",Ou);function mu(i){let e=screen.orientation?.angle??window.orientation??0,t=Math.abs(e)===90,n=t?i.beta==null?null:i.beta*(e===90?1:-1):i.gamma==null?null:i.gamma*(e===180?-1:1),s=t?i.gamma==null?null:i.gamma*(e===90?-1:1):i.beta;if(n!=null){Xr==null&&(Xr=n);let r=(n-Xr+540)%360-180,a=mt(r/22,-1,1)*aM;Ii+=(a-Ii)*.08}if(s!=null){qr==null&&(qr=s);let r=(s-qr+540)%360-180,a=mt(r/28,-1,1)*oM;es+=(a-es)*.07}}function Up(){Xr=null,qr=null,Ii=0,es=0}screen.orientation?.addEventListener?.("change",Up);window.addEventListener("orientationchange",Up);function hM(){ko||Vo||(ko=!0,typeof DeviceOrientationEvent<"u"&&typeof DeviceOrientationEvent.requestPermission=="function"?DeviceOrientationEvent.requestPermission().then(i=>{i==="granted"&&(Vo=!0,window.addEventListener("deviceorientation",mu))}).catch(()=>{ko=!1}):"DeviceOrientationEvent"in window&&(Vo=!0,window.addEventListener("deviceorientation",mu)))}var is=!1,ss=null,ts=.16,Wo=Ke*.75+.6,uM=1.5;function dM(i){if(is||i===qn||!Xn[i])return;if(je==="roller"){let t=ns[i];Au(t),yn=t,qn=i,Mn={from:t,to:t,t:1},ol(),na(),Ui(),ir();return}is=!0,Zr.forEach(t=>{t.disabled=!0});let e=Xn[i];Bt.setMaterial(e),Bt.setVisible(!0),Bt.setCastShadow(e.castShadow);for(let t of Bt.sims)t.spread=ts,t.openTargetSpread=1,t.openVelocity=0,t.offsetX=t.side*Wo,t.build(),t.kinematic={t:0,from:{spread:ts,offsetX:t.side*Wo},to:{spread:1,offsetX:0}};for(let t of Ne.sims)t.kinematic={t:0,from:{spread:1,offsetX:0},to:{spread:ts,offsetX:t.side*Wo}};Mn={from:yn,to:e,t:0},ss={next:i,to:e},Yo.classList.add("switching"),Zr.forEach(t=>t.setAttribute("aria-pressed",String(Number(t.dataset.product)===i))),setTimeout(()=>{let t=bu[ta()][i];Zf.textContent=t.name,Jf.textContent=t.color,Yo.classList.remove("switching")},380)}function fM(){if(!ss)return!1;let e=!0;for(let t of[Ne,Bt])for(let n of t.sims)n.kinematic.t=Math.min(1,n.kinematic.t+Xo/uM),n.kinematic.t<1&&(e=!1);return Mn.t=Kr(Ne.sims[0].kinematic.t),e}function pM(){let i=ss;Ne.setVisible(!1);for(let e of[...Ne.sims,...Bt.sims])e.kinematic=null;for(let e of Bt.sims)e.spread=1,e.openTargetSpread=1,e.openVelocity=0,e.offsetX=0;yn=i.to,qn=i.next,[Ne,Bt]=[Bt,Ne],Ne.setCastShadow(i.to.castShadow),Mn={from:i.to,to:i.to,t:1},ss=null,is=!1,Zr.forEach(e=>{e.disabled=!1}),na(),Ui(),ir()}Zr.forEach(i=>i.addEventListener("click",()=>dM(Number(i.dataset.product))));function mM(){op(Yn,Zn),Su(),lu=Ke*1.34,Wo=Ke*.75+.6,Ln=lu,Gn=Math.max(wu+yp,pt-_p),qt=In+.035-Gn;for(let i of Ne.sims)i.spread=1,i.openTargetSpread=1,i.openVelocity=0,i.offsetX=0,i.build();if(Bt.visible)for(let i of Bt.sims)i.build();ll(),He.rodParts?.forEach(i=>{i.visible=je!=="roller"}),Fp()}document.querySelectorAll("[data-step]").forEach(i=>{i.addEventListener("click",()=>{let e=Number(i.dataset.dir);i.dataset.step==="ancho"?sl(Yn+e*10,Zn):sl(Yn,Zn+e*10)})});var Gf=0;function sl(i,e,t=!0){Yn=mt(Math.round(i/10)*10,O_,B_),Zn=mt(Math.round(e/10)*10,H_,k_),kr.value=Yn,Vr.value=Zn,t&&mM(),Ui()}function Wf(){let i=Number(kr.value),e=Number(Vr.value);sl(Number.isFinite(i)?i:Yn,Number.isFinite(e)?e:Zn)}[kr,Vr].forEach(i=>{i.addEventListener("input",()=>{clearTimeout(Gf);let e=Number(kr.value),t=Number(Vr.value);!Number.isFinite(e)||!Number.isFinite(t)||!kr.value||!Vr.value||(Gf=setTimeout(Wf,160))}),i.addEventListener("blur",Wf),i.addEventListener("keydown",e=>{e.key==="Enter"&&(e.preventDefault(),i.blur())})});function Ui(){if(!If)return;let i=jr(),e=ta()==="roller"?"Roller":"Tradicional";If.textContent=`${i.name} ${e}`,h_.textContent=i.optics,u_.textContent=`${Yn} \xD7 ${Zn} cm`}function gM(){Ui(),Qf.hidden=!1,$f.hidden=!0,Ws.hidden=!0,qs.disabled=!1,qs.textContent="Solicitar mi cotizaci\xF3n",Rf.hidden=!1,requestAnimationFrame(()=>{Rf.scrollIntoView({behavior:"smooth",block:"start"}),setTimeout(()=>d_.focus({preventScroll:!0}),Zo?0:520)})}function Np(){o_.scrollIntoView({behavior:"smooth",block:"start"}),setTimeout(()=>jf.focus({preventScroll:!0}),Zo?0:520)}jf.addEventListener("click",gM);l_.addEventListener("click",Np);c_.addEventListener("click",Np);Cf.addEventListener("submit",async i=>{i.preventDefault();let e=Pf.value.trim();if(e.replace(/\D/g,"").length<8){Ws.textContent="Ingres\xE1 un WhatsApp v\xE1lido para que podamos enviarte la cotizaci\xF3n.",Ws.hidden=!1,Pf.focus();return}let t=jr(),n=ta(),s=new FormData(Cf).get("formato")||"pdf",r={telefono:e,tela_id:t.telaId,ancho_cm:Yn,alto_cm:Zn,formato:s,detalle:`${t.name} ${n==="roller"?"Roller":"Tradicional"} ${Yn} \xD7 ${Zn} cm`,origen:"cortina-viva",landing_url:location.href,referer_url:document.referrer||void 0};Ws.hidden=!0,qs.disabled=!0,qs.textContent="Enviando\u2026";try{let a=await fetch(y_,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(r)});if(!a.ok){let o=await a.json().catch(()=>({}));throw new Error(o?.error?.message||"No pudimos crear la solicitud.")}Qf.hidden=!0,$f.hidden=!1}catch(a){Ws.textContent=a.message||"No pudimos enviar la solicitud. Prob\xE1 nuevamente.",Ws.hidden=!1,qs.disabled=!1,qs.textContent="Reintentar solicitud"}});ol();na();Ui();var gu=!1;function Fu(){gu||(gu=!0,Kf.classList.add("visible"),Yo.classList.add("raised"),Hr.classList.add("hidden"))}var Ks=new L,xu=new L;function Fp(){let i=Math.max(.82,Ke/2.6,Pn/2.94);Ye.aspect<.8?(Ye.fov=54,Ks.set(3.4*i,1.75,5.2*i)):(Ye.fov=42,Ks.set(3.1*i,1.7,3.9*i)),xu.set(-.45,pt+Je*.42,ht),Ye.position.copy(Ks),Ye.lookAt(xu),Ye.updateProjectionMatrix()}function Ou(){let i=rn.getBoundingClientRect();Ye.aspect=i.width/i.height,Fp(),dp();let e=Math.sqrt(di.maxPixels/Math.max(1,i.width*i.height)),t=Math.min(window.devicePixelRatio||1,di.dpr,e)*Ko;Se.setPixelRatio(t),Se.setSize(i.width,i.height,!1);let n=Math.max(.82,Ko),s=Math.round(di.occlusion*n);Ru.setSize(s,Math.max(88,Math.round(s/Ye.aspect))),Cu.setSize(s,Math.max(88,Math.round(s/Ye.aspect)));let r=It==="full"?512:320,a=Math.max(180,Math.round(r/Ye.aspect));ia.setSize(r,a),Se.getDrawingBufferSize(pp),mp.set(1/r,1/a),Di.setPixelRatio(t),Di.setSize(i.width,i.height)}Ou();var Op=0,Bp=0,$h=0,eu=0;window.addEventListener("mousemove",i=>{Op=i.clientX/window.innerWidth*2-1,Bp=i.clientY/window.innerHeight*2-1});ir();Ui();var Xo=1/60,xM=6,Xf=performance.now(),tu=0,Fo=0,Oo=0,qf=0,nu=!!Jo,Yf=0;function vM(i){if(nu||document.hidden||i<=0)return;if(tu<20){tu+=1;return}if(tu+=1,Fo+=1,Oo+=i,Oo<1.1&&Fo<72)return;let e=Oo/Math.max(1,Fo);e>.024&&(qf+=1),qf>=2?(Ko=It==="full"?.82:.78,au="adaptive",Ou(),nu=!0):e<=.024?(au="stable",nu=!0):(Fo=0,Oo=0)}var qo,yM=new Promise(i=>{qo=i}),iu=0,su=0,Bo=new Uint8Array(4);function vu(i){let e=Math.min((i-Xf)/1e3,.16);if(Xf=i,document.hidden){requestAnimationFrame(vu);return}vM(e),Lp(i),Z_(e),_n+=(0-_n)*.035;let t=Math.min(xM,Math.max(1,Math.round(e/Xo))),n=!1;for(let c=0;c<t;c++){ss&&(n=fM()||n);let h=c===0&&je==="fabric"?Me:null;for(let u of Ne.sims)u.step(Xo,ss?Mn.from:yn,h,Ii,es);if(Bt.visible)for(let u of Bt.sims)u.step(Xo,Mn.to,null,Ii,es)}Me.active&&(Me.px=Me.x,Me.py=Me.y);for(let c=0;c<2;c++)hu(Ne.geos[c],Ne.sims[c]);if(Bt.visible)for(let c=0;c<2;c++)hu(Bt.geos[c],Bt.sims[c]);ir();let s=Zo?0:i*.001;Mu.uniforms.uTime.value=s,Qr.uniforms.time.value=s;let r=He.hazeStrength||0;for(let c of Gr.children){let{baseX:h,baseY:u,baseZ:d,baseScaleX:f,baseScaleY:g,phase:v,p:m,density:p}=c.userData;c.position.x=h+Math.sin(s*.15+v)*(.035+m*.075),c.position.y=u+Math.cos(s*.11+v*.7)*(.018+m*.035),c.position.z=d+Math.sin(s*.09+v*1.21)*(.024+m*.07);let w=.93+.07*Math.sin(s*.16+v*.63);c.scale.set(f*w,g/w,1),c.material.rotation+=Zo?0:28e-5*(v%2?1:-1),c.material.opacity=(.002+r*.11)*p*(.76+.24*Math.sin(s*.13+v))}n&&pM();let a=Me.active?Math.hypot(Me.x-Me.px,Me.y-Me.py):Math.abs(Ii)*.02;sM(a),$h+=(Op-$h)*.04,eu+=(Bp-eu)*.04,Ye.position.set(Ks.x+$h*.14,Ks.y-eu*.09,Ks.z),Ye.lookAt(xu),nM(),Q_(),$_(),Yf+=1;let o=Ne.sims.some(c=>c.relaxing),l=Me.active||!!fn||!!St||o||is||Math.abs(Ii)>.03||Math.abs(es)>.01;if(Se.shadowMap.autoUpdate||(Se.shadowMap.needsUpdate=l||Yf%2===0),Di.render(),qo){iu+=1;let c=Se.getContext();c.readPixels(4,Math.max(1,c.drawingBufferHeight-5),1,1,c.RGBA,c.UNSIGNED_BYTE,Bo),su=Bo[0]*.2126+Bo[1]*.7152+Bo[2]*.0722<88?su+1:0,(iu>=4&&su>=3||iu>=90)&&(qo(),qo=null)}requestAnimationFrame(vu)}async function _M(){await Promise.race([Promise.all(gp),new Promise(e=>setTimeout(e,5e3))]),await Promise.race([w_(),new Promise(e=>setTimeout(e,2500))]),Me.x=Me.px=0,Me.y=Me.py=Gn+qt*.5,Me.active=!0,Se.shadowMap.autoUpdate=!0,Se.shadowMap.needsUpdate=!0,Se.render(at,Ye),requestAnimationFrame(vu),await yM,Me.active=!1,await new Promise(requestAnimationFrame),ul(),await new Promise(requestAnimationFrame),Kf.classList.remove("visible"),Yo.classList.remove("raised"),Hr.classList.remove("hidden"),gu=!1,await new Promise(requestAnimationFrame),document.body.classList.add("scene-ready"),du=performance.now(),Ip(je,1400),setTimeout(Fu,2600),Se.shadowMap.autoUpdate=It==="full";let i=()=>{for(let e of Xn.filter((t,n)=>n!==tr))Qo(e.tex,!0,e.repeat*.55,e.repeat),Qo(e.normal,!1,e.repeat*.55,e.repeat)};"requestIdleCallback"in window?requestIdleCallback(i,{timeout:1800}):setTimeout(i,700)}_M();window.__cortina={getState:()=>({currentIndex:qn,anchoCm:Yn,altoCm:Zn,switching:is,interactionMode:je,rollerDrop:en,rollerTargetDrop:Jn,rollerRadius:Xs,rollerAngle:uu,rollerWidth:Ln*1.02,rollerWeight:{visible:bt.visible,width:bt.scale.x,height:bt.scale.y,y:bt.position.y,opaque:bt.material.userData.shadowBlock===1,internal:bt.material.userData.internalCounterweight===!0,colorWrite:bt.material.colorWrite},rollerUvSpan:Math.abs(Js.attributes.uv.getY(0)-Js.attributes.uv.getY(el*(Wr+1))),qualityTier:It,performanceMode:au,sceneReady:document.body.classList.contains("scene-ready"),onboarding:{active:St?.mode||null,elapsed:St?(performance.now()-St.startedAt)/1e3:null,visible:!Ys.hidden,shown:[...er],tried:["fabric","open","roller"].filter(Lu),rippleActive:!!Wn,guide:{x:Uf.getBoundingClientRect().x,y:Uf.getBoundingClientRect().y,fingerOpacity:Number(getComputedStyle(zo).opacity),labelOpacity:Number(getComputedStyle(ru).opacity)}},adaptiveRenderScale:Ko,renderDpr:Se.getPixelRatio(),qualitySignals:{memoryKnown:np,deviceMemory:ip,cpuCores:sp,saveData:rp,highDensityMobile:M_,constrainedDevice:ap},motion:{requested:ko,granted:Vo,tiltX:Ii,tiltGravity:es,baselineLateral:Xr,baselineGravity:qr},winW:Ke,winH:Je,winY:pt,curtainBottom:Gn,floorY:wu,interactionTargets:{left:Go(-Ln*.28,Gn+qt*.55),right:Go(Ln*.28,Gn+qt*.55),roller:Go(0,Gn+qt*.45)},sourceEnergy:He.sourceEnergy||0,hazeStrength:He.hazeStrength||0,interactionOpenEnergy:_n,floorProjection:{transmittedOpacity:jo.opacity,diffuseTexture:jo.map!==null,directionalBlockedByFabric:je==="roller"?Vt.castShadow:Ne.meshes.every(i=>i.castShadow)},opening:Ho(Ne),panelSpreads:Ne.sims.map(i=>i.spread),panelSpreadTargets:Ne.sims.map(i=>i.openTargetSpread),panelOpenVelocities:Ne.sims.map(i=>i.openVelocity),productName:jr().name,productColor:jr().color,opticalProfile:{frostMix:yn.frostMix,frostLod:yn.frostLod,shadowBlock:yn.shadowBlock,sunFactor:yn.sunFactor,rollerTexture:yn.rollerTexture||null},panels:Ne.meshes.map((i,e)=>{let t=i.geometry.getAttribute("position"),n=1/0,s=-1/0,r=1/0,a=-1/0,o=1/0,l=-1/0,c=0,h=0;for(let O=0;O<t.count;O++){n=Math.min(n,t.getX(O)),s=Math.max(s,t.getX(O)),r=Math.min(r,t.getY(O)),a=Math.max(a,t.getY(O)),o=Math.min(o,t.getZ(O)),l=Math.max(l,t.getZ(O));let C=Ne.sims[e].points[O],Z=In+.035-C.v*qt;c+=Math.hypot(C.x-Ne.sims[e].anchorX(C.baseX),C.y-Z),h=Math.max(h,Math.abs(C.y-Z))}let u=1/0,d=-1/0,f=0;for(let O=At*Qi;O<t.count;O++)u=Math.min(u,t.getY(O)),d=Math.max(d,t.getY(O)),f=Math.max(f,Math.abs(t.getZ(O)));let g=1/0,v=-1/0,m=t.getX(0),p=t.getX(At*Qi),w=0;for(let O=0;O<=At;O++){let C=t.getX(O*Qi);g=Math.min(g,C),v=Math.max(v,C),w=Math.max(w,Math.abs(C-kn(m,p,O/At)))}let _=At*Qi,b=Math.max(Math.abs(t.getZ(_+1)),Math.abs(t.getZ(_+Ft-1))),U=[];for(let O=0;O<=Ft;O++){let C=_+O,Z=new L(t.getX(C),t.getY(C),t.getZ(C));i.localToWorld(Z).project(Ye),U.push([(Z.x*.5+.5)*rn.clientWidth,(-Z.y*.5+.5)*rn.clientHeight])}let[A,T]=U[0],[R,W]=U[U.length-1],x=R-A,M=W-T,z=Math.hypot(x,M)||1,B=0;for(let[O,C]of U){let Z=Math.abs(M*O-x*C+R*T-W*A)/z;B=Math.max(B,Z)}let I=0;for(let O=1;O<U.length-1;O++){let[C,Z]=U[O-1],[G,ie]=U[O],[ne,he]=U[O+1],be=ne-C,Re=he-Z,q=Math.hypot(be,Re)||1,$=Math.abs(Re*G-be*ie+ne*Z-he*C)/q;I=Math.max(I,$)}return{visible:i.visible,opacity:i.material?.opacity??null,minX:n,maxX:s,minY:r,maxY:a,minZ:o,maxZ:l,hemMinY:u,hemMaxY:d,hemMaxAbsZ:f,outerEdgeMinX:g,outerEdgeMaxX:v,outerEdgeSpan:v-g,outerEdgeCurveMax:w,bottomCornerDepth:b,hemProjectedDeviationPx:B,hemProjectedKinkPx:I,meanRestDisplacement:c/t.count,maxVerticalDisplacement:h}})}),pokeScreen:(i,e,t,n)=>{let s=Vn(i-t,e-n),r=Vn(i,e);s&&r&&(Pu(r.x,r.y,r.x-s.x),sr(),Me.active=!0,Me.px=s.x,Me.py=s.y,Me.x=r.x,Me.y=r.y,dl())},setMode:$r,playOnboarding:(i=je)=>Pp(i,!0),seekOnboarding:i=>{if(!St)return!1;let e=Math.max(0,Number(i)||0);St.startedAt=performance.now()-e*1e3;for(let t of nl)t.currentTime=e*1e3;return Lp(performance.now()),!0},resetOnboarding:()=>{hl(!0),er.clear(),fu.clear();try{for(let i of["fabric","open","roller"])localStorage.removeItem(`${Iu}${i}`)}catch{}},screenToWorld:(i,e)=>{let t=Vn(i,e);return t?{x:t.x,y:t.y}:null},dragMode:(i,e,t,n)=>{let s=Vn(i,e),r=s?{x:s.x,y:s.y}:null,a=Vn(t,n),o=a?{x:a.x,y:a.y}:null;Uu(r),Nu(o);let l={start:r?{x:r.x,y:r.y}:null,end:o?{x:o.x,y:o.y}:null,spreads:Ne.sims.map(c=>c.spread),spreadTargets:Ne.sims.map(c=>c.openTargetSpread),rollerDrop:en,rollerTargetDrop:Jn};return sa(),l},injectOrientation:(i,e)=>mu({beta:i,gamma:e}),jumpToProduct:i=>{if(i===qn||i<0||i>=Xn.length)return;let e=Xn[i],t=je==="roller"?ns[i]:e;Ne.setMaterial(e),Ne.setCastShadow(e.castShadow),Au(ns[i]);for(let n of Ne.sims)n.spread=1,n.openTargetSpread=1,n.openVelocity=0,n.offsetX=0,n.build(),n.kinematic=null;yn=t,qn=i,Mn={from:t,to:t,t:1},ol(),na(),Ui();for(let n=0;n<2;n++)hu(Ne.geos[n],Ne.sims[n]);ir()},setSize:(i,e)=>{sl(i,e)}};
