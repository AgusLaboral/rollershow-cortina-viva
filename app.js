...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:In,depthTest:!1,depthWrite:!1})}function ed(){return new lt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:bh(),fragmentShader:`
		...
		`,blending:In,depthTest:!1,depthWrite:!1})}function td(){return new lt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:bh(),fragmentShader:`
	...
	`}function ox(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){let l=o.mapping,c=l===dr||l===Xl,h=l===bs||l===ws;if(c||h){let u=e.get(o),d=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new Va(i)),u=c?t.fromEquirectangular(o,u):t.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),u.texture;if(u!==void 0)return u.texture;{let f=o.image;return c&&f&&f.height>0||h&&f&&s(f)?(t===null&&(t=new Va(i)),u=c?t.fromEquirectangular(o):t.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),o.addEventListener("dispose",r),u.texture):null}}}return o}function s(o){let l=0,c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function r(o){let l=o.target;l.removeEventListener("dispose",r);let c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function lx(i){let e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){let s=t(n);return s===null&&Ca("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function cx(i,e,t,n){let s={},r=new WeakMap;function a(u){let d=u.target;d.index!==null&&e.remove(d.index);for(let g in d.attributes)e.remove(d.attributes[g]);for(let g in d.morphAttributes){let _=d.morphAttributes[g];for(let p=0,m=_.length;p<m;p++)e.remove(_[p])}d.removeEventListener("dispose",a),delete s[d.id];let f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(u,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,t.memory.geometries++),d}function l(u){let d=u.attributes;for(let g in d)e.update(d[g],i.ARRAY_BUFFER);let f=u.morphAttributes;for(let g in f){let _=f[g];for(let p=0,m=_.length;p<m;p++)e.update(_[p],i.ARRAY_BUFFER)}}function c(u){let d=[],f=u.index,g=u.attributes.position,_=0;if(f!==null){let w=f.array;_=f.version;for(let M=0,b=w.length;M<b;M+=3){let F=w[M+0],R=w[M+1],T=w[M+2];d.push(F,R,R,T,T,F)}}else if(g!==void 0){let w=g.array;_=g.version;for(let M=0,b=w.length/3-1;M<b;M+=3){let F=M+0,R=M+1,T=M+2;d.push(F,R,R,T,T,F)}}else return;let p=new(qd(d)?za:Ba)(d,1);p.version=_;let m=r.get(u);m&&e.remove(m),r.set(u,p)}function h(u){let d=r.get(u);if(d){let f=u.index;f!==null&&d.version<f.version&&c(u)}else c(u);return r.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function hx(i,e,t){let n;function s(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function l(d,f){i.drawElements(n,f,r,d*a),t.update(f,n,1)}function c(d,f,g){g!==0&&(i.drawElementsInstanced(n,f,r,d*a,g),t.update(f,n,g))}function h(d,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,g);let p=0;for(let m=0;m<g;m++)p+=f[m];t.update(p,n,1)}function u(d,f,g,_){if(g===0)return;let p=e.get("WEBGL_multi_draw");if(p===null)for(let m=0;m<d.length;m++)c(d[m]/a,f[m],_[m]);else{p.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,_,0,g);let m=0;for(let w=0;w<g;w++)m+=f[w];for(let w=0;w<_.length;w++)t.update(m,n,_[w])}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function ux(i){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function dx(i,e,t){let n=new WeakMap,s=new gt;function r(a,o,l){let c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0,d=n.get(o);if(d===void 0||d.count!==u){let W=function(){T.dispose(),n.delete(o),o.removeEventListener("dispose",W)};d!==void 0&&d.texture.dispose();let f=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,_=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],m=o.morphAttributes.normal||[],w=o.morphAttributes.color||[],M=0;f===!0&&(M=1),g===!0&&(M=2),_===!0&&(M=3);let b=o.attributes.position.count*M,F=1;b>e.maxTextureSize&&(F=Math.ceil(b/e.maxTextureSize),b=e.maxTextureSize);let R=new Float32Array(b*F*4*u),T=new Fa(R,b,F,u);T.type=hn,T.needsUpdate=!0;let C=M*4;for(let x=0;x<u;x++){let y=p[x],B=m[x],O=w[x],A=b*F*4*x;for(let z=0;z<y.count;z++){let L=z*C;f===!0&&(s.fromBufferAttribute(y,z),R[A+L+0]=s.x,R[A+L+1]=s.y,R[A+L+2]=s.z,R[A+L+3]=0),g===!0&&(s.fromBufferAttribute(B,z),R[A+L+4]=s.x,R[A+L+5]=s.y,R[A+L+6]=s.z,R[A+L+7]=0),_===!0&&(s.fromBufferAttribute(O,z),R[A+L+8]=s.x,R[A+L+9]=s.y,R[A+L+10]=s.z,R[A+L+11]=O.itemSize===4?s.w:1)}}d={count:u,texture:T,size:new Q(b,F)},n.set(o,d),o.addEventListener("dispose",W)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let f=0;for(let _=0;_<c.length;_++)f+=c[_];let g=o.morphTargetsRelative?1:1-f;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function fx(i,e,t,n){let s=new WeakMap;function r(l){let c=n.render.frame,h=l.geometry,u=e.get(l,h);if(s.get(u)!==c&&(e.update(u),s.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){let d=l.skeleton;s.get(d)!==c&&(d.update(),s.set(d,c))}return u}function a(){s=new WeakMap}function o(l){let c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}var Ga=class extends Lt{constructor(e,t,n,s,r,a,o,l,c,h=_s){if(h!==_s&&h!==Ts)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===_s&&(n=Hi),n===void 0&&h===Ts&&(n=Es),super(null,s,r,a,o,l,h,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Ot,this.minFilter=l!==void 0?l:Ot,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){let t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}},Kd=new Lt,nd=new Ga(1,1),jd=new Fa,Qd=new wc,$d=new ka,id=[],sd=[],rd=new Float32Array(16),ad=new Float32Array(9),od=new Float32Array(4);function Ds(i,e,t){let n=i[0];if(n<=0||n>0)return i;let s=e*t,r=id[s];if(r===void 0&&(r=new Float32Array(s),id[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function Tt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function At(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function uo(i,e){let t=sd[e];t===void 0&&(t=new Int32Array(e),sd[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function px(i,e){let t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function mx(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Tt(t,e))return;i.uniform2fv(this.addr,e),At(t,e)}}function gx(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Tt(t,e))return;i.uniform3fv(this.addr,e),At(t,e)}}function xx(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Tt(t,e))return;i.uniform4fv(this.addr,e),At(t,e)}}function vx(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(Tt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),At(t,e)}else{if(Tt(t,n))return;od.set(n),i.uniformMatrix2fv(this.addr,!1,od),At(t,n)}}function _x(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(Tt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),At(t,e)}else{if(Tt(t,n))return;ad.set(n),i.uniformMatrix3fv(this.addr,!1,ad),At(t,n)}}function yx(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(Tt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),At(t,e)}else{if(Tt(t,n))return;rd.set(n),i.uniformMatrix4fv(this.addr,!1,rd),At(t,n)}}function Mx(i,e){let t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Sx(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Tt(t,e))return;i.uniform2iv(this.addr,e),At(t,e)}}function bx(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Tt(t,e))return;i.uniform3iv(this.addr,e),At(t,e)}}function wx(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Tt(t,e))return;i.uniform4iv(this.addr,e),At(t,e)}}function Ex(i,e){let t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Tx(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Tt(t,e))return;i.uniform2uiv(this.addr,e),At(t,e)}}function Ax(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Tt(t,e))return;i.uniform3uiv(this.addr,e),At(t,e)}}function Rx(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Tt(t,e))return;i.uniform4uiv(this.addr,e),At(t,e)}}function Cx(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(nd.compareFunction=Xd,r=nd):r=Kd,t.setTexture2D(e||r,s)}function Px(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Qd,s)}function Ix(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||$d,s)}function Lx(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||jd,s)}function Dx(i){switch(i){case 5126:return px;case 35664:return mx;case 35665:return gx;case 35666:return xx;case 35674:return vx;case 35675:return _x;case 35676:return yx;case 5124:case 35670:return Mx;case 35667:case 35671:return Sx;case 35668:case 35672:return bx;case 35669:case 35673:return wx;case 5125:return Ex;case 36294:return Tx;case 36295:return Ax;case 36296:return Rx;case 35678:case 36198:case 36298:case 36306:case 35682:return Cx;case 35679:case 36299:case 36307:return Px;case 35680:case 36300:case 36308:case 36293:return Ix;case 36289:case 36303:case 36311:case 36292:return Lx}}function Ux(i,e){i.uniform1fv(this.addr,e)}function Nx(i,e){let t=Ds(e,this.size,2);i.uniform2fv(this.addr,t)}function Fx(i,e){let t=Ds(e,this.size,3);i.uniform3fv(this.addr,t)}function Ox(i,e){let t=Ds(e,this.size,4);i.uniform4fv(this.addr,t)}function Bx(i,e){let t=Ds(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function zx(i,e){let t=Ds(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Hx(i,e){let t=Ds(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function kx(i,e){i.uniform1iv(this.addr,e)}function Vx(i,e){i.uniform2iv(this.addr,e)}function Gx(i,e){i.uniform3iv(this.addr,e)}function Wx(i,e){i.uniform4iv(this.addr,e)}function Xx(i,e){i.uniform1uiv(this.addr,e)}function qx(i,e){i.uniform2uiv(this.addr,e)}function Yx(i,e){i.uniform3uiv(this.addr,e)}function Zx(i,e){i.uniform4uiv(this.addr,e)}function Jx(i,e,t){let n=this.cache,s=e.length,r=uo(t,s);Tt(n,r)||(i.uniform1iv(this.addr,r),At(n,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||Kd,r[a])}function Kx(i,e,t){let n=this.cache,s=e.length,r=uo(t,s);Tt(n,r)||(i.uniform1iv(this.addr,r),At(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Qd,r[a])}function jx(i,e,t){let n=this.cache,s=e.length,r=uo(t,s);Tt(n,r)||(i.uniform1iv(this.addr,r),At(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||$d,r[a])}function Qx(i,e,t){let n=this.cache,s=e.length,r=uo(t,s);Tt(n,r)||(i.uniform1iv(this.addr,r),At(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||jd,r[a])}function $x(i){switch(i){case 5126:return Ux;case 35664:return Nx;case 35665:return Fx;case 35666:return Ox;case 35674:return Bx;case 35675:return zx;case 35676:return Hx;case 5124:case 35670:return kx;case 35667:case 35671:return Vx;case 35668:case 35672:return Gx;case 35669:case 35673:return Wx;case 5125:return Xx;case 36294:return qx;case 36295:return Yx;case 36296:return Zx;case 35678:case 36198:case 36298:case 36306:case 35682:return Jx;case 35679:case 36299:case 36307:return Kx;case 35680:case 36300:case 36308:case 36293:return jx;case 36289:case 36303:case 36311:case 36292:return Qx}}var Ac=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Dx(t.type)}},Rc=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=$x(t.type)}},Cc=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let s=this.seq;for(let r=0,a=s.length;r!==a;++r){let o=s[r];o.setValue(e,t[o.id],n)}}},Pl=/(\w+)(\])?(\[|\.)?/g;function ld(i,e){i.seq.push(e),i.map[e.id]=e}function ev(i,e,t){let n=i.name,s=n.length;for(Pl.lastIndex=0;;){let r=Pl.exec(n),a=Pl.lastIndex,o=r[1],l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){ld(t,c===void 0?new Ac(o,i,e):new Rc(o,i,e));break}else{let u=t.map[o];u===void 0&&(u=new Cc(o),ld(t,u)),t=u}}}var Ms=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){let r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);ev(r,a,this)}}setValue(e,t,n,s){let r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){let s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){let o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){let n=[];for(let s=0,r=e.length;s!==r;++s){let a=e[s];a.id in t&&n.push(a)}return n}};function cd(i,e,t){let n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}var tv=37297,nv=0;function iv(i,e){let t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){let o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}function sv(i){let e=qe.getPrimaries(qe.workingColorSpace),t=qe.getPrimaries(i),n;switch(e===t?n="":e===Da&&t===La?n="LinearDisplayP3ToLinearSRGB":e===La&&t===Da&&(n="LinearSRGBToLinearDisplayP3"),i){case Ln:case ho:return[n,"LinearTransferOETF"];case Et:case Sh:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function hd(i,e,t){let n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";let r=/ERROR: 0:(\d+)/.exec(s);if(r){let a=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+iv(i.getShaderSource(e),a)}else return s}function rv(i,e){let t=sv(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function av(i,e){let t;switch(e){case hh:t="Linear";break;case uh:t="Reinhard";break;case dh:t="Cineon";break;case Ar:t="ACESFilmic";break;case fh:t="AgX";break;case ph:t="Neutral";break;case Np:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var ga=new I;function ov(){qe.getLuminanceCoefficients(ga);let i=ga.x.toFixed(4),e=ga.y.toFixed(4),t=ga.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function lv(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(or).join(`
`)}function cv(i){let e=[];for(let t in i){let n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function hv(i,e){let t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(e,s),a=r.name,o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function or(i){return i!==""}function ud(i,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function dd(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var uv=/^[ \t]*#include +<([\w\d./]+)>/gm;function Pc(i){return i.replace(uv,fv)}var dv=new Map;function fv(i,e){let t=Ne[e];if(t===void 0){let n=dv.get(e);if(n!==void 0)t=Ne[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Pc(t)}var pv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function fd(i){return i.replace(pv,mv)}function mv(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function pd(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function gv(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Id?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===ch?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===jn&&(e="SHADOWMAP_TYPE_VSM"),e}function xv(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case bs:case ws:e="ENVMAP_TYPE_CUBE";break;case co:e="ENVMAP_TYPE_CUBE_UV";break}return e}function vv(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ws:e="ENVMAP_MODE_REFRACTION";break}return e}function _v(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ld:e="ENVMAP_BLENDING_MULTIPLY";break;case Dp:e="ENVMAP_BLENDING_MIX";break;case Up:e="ENVMAP_BLENDING_ADD";break}return e}function yv(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Mv(i,e,t,n){let s=i.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,l=gv(t),c=xv(t),h=vv(t),u=_v(t),d=yv(t),f=lv(t),g=cv(r),_=s.createProgram(),p,m,w=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+m);let M=w+p+a,b=w+m+o,F=cd(s,s.VERTEX_SHADER,M),R=cd(s,s.FRAGMENT_SHADER,b);s.attachShader(_,F),s.attachShader(_,R),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function T(y){if(i.debug.checkShaderErrors){let B=s.getProgramInfoLog(_).trim(),O=s.getShaderInfoLog(F).trim(),A=s.getShaderInfoLog(R).trim(),z=!0,L=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,F,R);else{let K=hd(s,F,"vertex"),G=hd(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Ns.BlurDirectionX=new Q(1,0);Ns.BlurDirectionY=new Q(0,1);var af={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
...
`;continue}if((L=z.match(x))&&(A.gamma=parseFloat(L[1])),(L=z.match(y))&&(A.exposure=parseFloat(L[1])),(L=z.match(B))&&(A.valid|=2,A.format=L[1]),(L=z.match(O))&&(A.valid|=4,A.height=parseInt(L[1],10),A.width=parseInt(L[2],10)),A.valid&2&&A.valid&4)break}return A.valid&2||a(3,"missing format specifier"),A.valid&4||a(3,"missing image size specifier"),A},f=function(C,W,x){let y=W;if(y<8||y>32767||C[0]!==2||C[1]!==2||C[2]&128)return new Uint8Array(C);y!==(C[2]<<8|C[3])&&a(3,"wrong scanline width");let B=new Uint8Array(4*W*x);B.length||a(4,"unable to allocate buffer space");let O=0,A=0,z=4*y,L=new Uint8Array(4),K=new Uint8Array(z),G=x;for(;G>0&&A<C.byteLength;){A+4>C.byteLength&&a(1),L[0]=C[A++],L[1]=C[A++],L[2]=C[A++],L[3]=C[A++],(L[0]!=2||L[1]!=2||(L[2]<<8|L[3])!=y)&&a(3,"bad rgbe scanline format");let ie=0,ne;for(;ie<z&&A<C.byteLength;){ne=C[A++];let be=ne>128;if(be&&(ne-=128),(ne===0||ie+ne>z)&&a(3,"bad scanline data"),be){let Ie=C[A++];for(let q=0;q<ne;q++)K[ie++]=Ie}else K.set(C.subarray(A,A+ne),ie),ie+=ne,A+=ne}let he=y;for(let be=0;be<he;be++){let Ie=0;B[O]=K[be+Ie],Ie+=y,B[O+1]=K[be+Ie],Ie+=y,B[O+2]=K[be+Ie],Ie+=y,B[O+3]=K[be+Ie],O+=4}G--}return B},g=function(C,W,x,y){let B=C[W+3],O=Math.pow(2,B-128)/255;x[y+0]=C[W+0]*O,x[y+1]=C[W+1]*O,x[y+2]=C[W+2]*O,x[y+3]=1},_=function(C,W,x,y){let B=C[W+3],O=Math.pow(2,B-128)/255;x[y+0]=Rr.toHalfFloat(Math.min(C[W+0]*O,65504)),x[y+1]=Rr.toHalfFloat(Math.min(C[W+1]*O,65504)),x[y+2]=Rr.toHalfFloat(Math.min(C[W+2]*O,65504)),x[y+3]=Rr.toHalfFloat(1)},p=new Uint8Array(e);p.pos=0;let m=d(p),w=m.width,M=m.height,b=f(p.subarray(p.pos),w,M),F,R,T;switch(this.type){case hn:T=b.length/4;let C=new Float32Array(T*4);for(let x=0;x<T;x++)g(b,x*4,C,x*4);F=C,R=hn;break;case Rt:T=b.length/4;let W=new Uint16Array(T*4);for(let x=0;x<T;x++)_(b,x*4,W,x*4);F=W,R=Rt;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:w,height:M,data:F,header:m.string,gamma:m.gamma,exposure:m.exposure,type:R}}setDataType(e){return this.type=e,this}load(e,t,n,s){function r(a,o){switch(a.type){case hn:case Rt:a.colorSpace=Ln,a.minFilter=ft,a.magFilter=ft,a.generateMipmaps=!1,a.flipY=!0;break}t&&t(a,o)}return super.load(e,r,n,s)}};var Pr={name:"SMAAEdgesShader",defines:{SMAA_THRESHOLD:"0.1"},uniforms:{tDiffuse:{value:null},resolution:{value:new Q(1/1024,1/512)}},vertexShader:`
		...
		}`},Ir={name:"SMAAWeightsShader",defines:{SMAA_MAX_SEARCH_STEPS:"8",SMAA_AREATEX_MAX_DISTANCE:"16",SMAA_AREATEX_PIXEL_SIZE:"( 1.0 / vec2( 160.0, 560.0 ) )",SMAA_AREATEX_SUBTEX_SIZE:"( 1.0 / 7.0 )"},uniforms:{tDiffuse:{value:null},tArea:{value:null},tSearch:{value:null},resolution:{value:new Q(1/1024,1/512)}},vertexShader:`
...
`)});function j_(){let i=document.createElement("canvas");i.width=i.height=256;let e=i.getContext("2d");e.clearRect(0,0,256,256);let t=[[128,128,112,1],[92,120,78,.46],[166,104,68,.36],[144,164,82,.32]];for(let[s,r,a,o]of t){let l=e.createRadialGradient(s,r,0,s,r,a);l.addColorStop(0,`rgba(255,255,255,${o})`),l.addColorStop(.36,`rgba(255,255,255,${o*.48})`),l.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=l,e.fillRect(0,0,256,256)}let n=new Cs(i);return n.colorSpace=Et,n}var Q_=j_(),Fr=new Pn;rt.add(Fr);var Un=new I(-1.2,-3,7.2).normalize();function $_(){let i=document.createElement("canvas");i.width=i.height=256;let e=i.getContext("2d"),t=e.createImageData(256,256);for(let s=0;s<256;s++)for(let r=0;r<256;r++){let a=Math.abs((r+.5)/128-1),o=Math.abs((s+.5)/128-1),l=Math.max(a*.78,o),c=1-Hh(.48,1,l),h=Math.max(0,1-Math.sqrt(a*a*.28+o*o*.5)*.28),u=Math.round(255*c*h),d=(s*256+r)*4;t.data[d]=t.data[d+1]=t.data[d+2]=255,t.data[d+3]=u}e.putImageData(t,0,0);let n=new Cs(i);return n.colorSpace=Et,n}var Oo=new Jt({map:$_(),color:16767408,transparent:!0,opacity:0,blending:vi,depthWrite:!1,side:Yt,toneMapped:!0}),Nn=new Pn;rt.add(Nn);var Lr=null,He={};function Gf(){if(!He.sun)return;let i=Math.max(10,Ke*2);He.sun.shadow.camera.left=-i,He.sun.shadow.camera.right=Math.max(i,Ye.aspect*9),He.sun.shadow.camera.top=Math.max(6,En+1.4),He.sun.shadow.camera.bottom=-4,He.sun.shadow.camera.updateProjectionMatrix()}function nu(){for(let A of[...Nn.children])Nn.remove(A),A.geometry&&A.geometry.dispose();let i=new Sr;i.moveTo(-qi.w/2,0),i.lineTo(qi.w/2,0),i.lineTo(qi.w/2,qi.h),i.lineTo(-qi.w/2,qi.h),i.closePath();let e=new Ps;e.moveTo(-Ke/2,dt),e.lineTo(Ke/2,dt),e.lineTo(Ke/2,En),e.lineTo(-Ke/2,En),e.closePath(),i.holes.push(e),Xs.geometry.dispose(),Xs.geometry=new Qa(i);let t=.06,n=(A,z,L,K,G,ie)=>{let ne=new et(new ii(A,z,L),q_);ne.position.set(K,G,ie),ne.castShadow=!0,Nn.add(ne)};n(Ke+t*2,t,.14,0,En+t/2,ct),n(Ke+t*2,t,.14,0,dt-t/2+.01,ct),n(t,Je+t*2,.14,-Ke/2-t/2,dt+Je/2,ct),n(t,Je+t*2,.14,Ke/2+t/2,dt+Je/2,ct),n(t*1.3,Je,.12,0,dt+Je/2,ct);let s=t*.5,r=Math.max(2,Math.round(Je/.65));for(let A of[-1,1]){let z=A*Ke/4;n(s,Je,.09,z,dt+Je/2,ct);for(let L=1;L<r;L++)n(Ke/2-t,s,.09,z,dt+Je/r*L,ct)}Lr=new et(new bn(Ke-.02,Je-.02),Y_),Lr.renderOrder=1,Lr.position.set(0,dt+Je/2,ct+.012),Nn.add(Lr);let a=new et(new bn(Math.max(9,Ke*3),Math.max(7,Je*2.5)),K_);a.position.set(0,dt+Je/2,ct-1.3),Nn.add(a);let o=Ke*1.24,l=new et(new Mr(.016,.016,o,24),pf);l.rotation.z=Math.PI/2,l.position.set(0,zn-.24,ct),l.castShadow=!0,Nn.add(l),He.rodParts=[l];for(let A of[-o*.5,o*.5]){let z=new et(new $a(.032,16,16),pf);z.position.set(A,zn-.24,ct),Nn.add(z),He.rodParts.push(z)}let c=(A,z,L)=>{let K=z/-Un.y;return[A+Un.x*K,.001,L+Un.z*K]},h=Ke*.58,u=Math.max(.002,dt-Je*.035),d=[-h,En+Je*.035,ct+.02],f=[h,En+Je*.035,ct+.02],g=[-h,u,ct+.02],_=[h,u,ct+.02],p=c(d[0],d[1],d[2]),m=c(f[0],f[1],f[2]),w=new Bt,M=[].concat(d,f,g,_,p,m);w.setAttribute("position",new It(new Float32Array(M),3)),w.setAttribute("aBeamUv",new It(new Float32Array([0,0,1,0,0,.12,1,.12,0,1,1,1]),2)),w.setIndex([0,1,5,0,5,4,2,3,5,2,5,4]);let b=new et(w,tu);Nn.add(b),He.shaft=b;let F=(A,z)=>{let L=z/Math.max(.001,-Un.y);return[A+Un.x*L,.004,ct+.03+Un.z*L]},R=F(-Ke/2,dt),T=F(Ke/2,dt),C=F(Ke/2,En),W=F(-Ke/2,En);He.beamEndWorld||(He.beamEndWorld=new I),He.beamEndWorld.set((W[0]+C[0])*.5,.004,(W[2]+C[2])*.5);let x=new Bt;x.setAttribute("position",new It(new Float32Array([...R,...T,...C,...W]),3)),x.setAttribute("uv",new It(new Float32Array([0,0,1,0,1,1,0,1]),2)),x.setIndex([0,1,2,0,2,3]),x.computeVertexNormals();let y=new et(x,Oo);y.renderOrder=2,Nn.add(y),He.transmittedPool=y;for(let A of[...Fr.children])A.material.dispose();Fr.clear();let B=0,O=(dt+Je*.55)/Math.max(.001,-Un.y);for(let A=0;A<B;A++){let z=Math.pow((A+.35)/B,1.35),L=O*z,K=new _r({map:Q_,color:16758888,transparent:!0,opacity:0,depthWrite:!1,blending:vi,toneMapped:!1}),G=new Ya(K),ie=Math.sin(A*2.17)*Ke*(.08+z*.18),ne=Math.cos(A*1.37)*Je*.045,he=Math.sin(A*.91)*(.035+z*.11),be=Un.x*L+ie,Ie=dt+Je*.55+Un.y*L+ne,q=ct+.08+Un.z*L+he;G.position.set(be,Ie,q),G.scale.set(Ke*(.34+z*.58),Je*(.14+z*.27),1),G.material.rotation=A%5*.37,G.userData={baseX:be,baseY:Ie,baseZ:q,phase:A*1.73,p:z,density:.72+.28*Math.sin(A*3.11),baseScaleX:Ke*(.34+z*.58),baseScaleY:Je*(.14+z*.27)},Fr.add(G)}He.sun&&(He.sun.target.position.set(-Ke*.2,.05,1.6),Gf()),He.glowPlane&&(He.glowPlane.scale.set(Ke+.08,Je+.08,1),He.glowPlane.position.set(0,dt+Je/2,ct-.02)),He.lightWorldPos&&He.lightWorldPos.set(0,dt+Je/2,ct)}Bf(120,150);nu();var Wf=18,kt=new ro(16768949,Wf);kt.position.set(.75,3,ct-3);kt.target.position.set(-.45,0,2);kt.castShadow=!0;kt.shadow.mapSize.set(ai.shadow,ai.shadow);kt.shadow.camera.near=.5;kt.shadow.camera.far=30;kt.shadow.camera.left=-4;kt.shadow.camera.right=4;kt.shadow.camera.top=4;kt.shadow.camera.bottom=-4;kt.shadow.bias=-4e-4;kt.shadow.normalBias=.018;kt.shadow.radius=Nt==="full"?2:1;rt.add(kt,kt.target);He.sun=kt;var ey=new ao(14148338,.2);rt.add(ey);nu();var ri=[{name:"Blackout",color:"Blanco",tex:"img/fabric/blackout-albedo.jpg",normal:"img/fabric/blackout-nor.webp",stiffness:.91,gravity:7.8,friction:.977,influence:.7,dragCap:.075,dragResponse:.82,pleatDepth:.095,compressionDepth:.035,roughness:.92,opacity:1,frostMix:0,frostLod:0,weaveStrength:0,foldShade:.34,backfaceCap:.18,castShadow:!0,shadowBlock:1,tint:16777215,sunFactor:0,backlight:0,radianceCap:.34,normalScale:.14,repeat:1.6},{name:"Gasa",color:"Beige",tex:"img/fabric/gasa.jpg",normal:"img/fabric/gasa-nor.webp",stiffness:.87,gravity:6.2,friction:.972,influence:.6,dragCap:.075,dragResponse:.9,pleatDepth:.075,compressionDepth:.08,roughness:.88,opacity:1,frostMix:.74,frostLod:zs?3.28:4.1,weaveStrength:.64,foldShade:.14,backfaceCap:1,castShadow:!0,shadowBlock:.18,tint:16776181,sunFactor:.84,backlight:0,radianceCap:.62,normalScale:.17,repeat:2.35},{name:"Tusor",color:"Natural",tex:"img/fabric/tusor-albedo.jpg",normal:"img/fabric/tusor-nor.webp",stiffness:.9,gravity:6.9,friction:.975,influence:.56,dragCap:.066,dragResponse:.72,pleatDepth:.09,compressionDepth:.065,roughness:.92,opacity:1,frostMix:.5,frostLod:4.2,weaveStrength:.68,foldShade:.26,backfaceCap:.72,castShadow:!0,shadowBlock:.56,tint:16775405,sunFactor:.46,backlight:0,radianceCap:.48,normalScale:.24,repeat:2.05}],iu=1,Tn=ri[iu],su={traditional:[{name:"Blackout",color:"Blanco",optics:"Sin paso",telaId:2009},{name:"Gasa",color:"Beige",optics:"Paso alto",telaId:1999},{name:"Tusor",color:"Natural",optics:"Paso medio",telaId:2006}],roller:[{name:"Blackout",color:"Blanco",optics:"Sin paso",telaId:1746},{name:"Screen",color:"Beige",optics:"Paso alto",telaId:1756},{name:"Decorativa",color:"Natural",optics:"Paso medio",telaId:1585}]},Wr=()=>_t==="roller"?"roller":"traditional",ru=()=>su[Wr()][Fn];function Xr(){let i=Wr(),e=su[i];Hr.forEach(t=>{let n=Number(t.dataset.product),s=e[n];t.querySelector("b").textContent=s.name,t.querySelector("small").textContent=s.optics,t.setAttribute("aria-pressed",String(n===Fn)),t.setAttribute("aria-label",`${s.name}: ${s.optics}`)})}function Xo(){let i=ru();Ef.textContent=i.name,Tf.textContent=i.color}var qr=new xt(512,288,{minFilter:Cn,magFilter:ft,depthBuffer:!0});qr.texture.colorSpace=Et;qr.texture.generateMipmaps=!0;var Xf=new Q(1,1),qf=new Q(1/512,1/288),ty=new Tr,Rh=new Map,Yf=[];function qs(i,e,t,n){let s=`${i}|${e}|${t}|${n??t}`;if(Rh.has(s))return Rh.get(s);let r,a=new Promise(l=>{r=l}),o=ty.load(i,r,void 0,r);return(i===Tn.tex||i===Tn.normal)&&Yf.push(a),o.wrapS=o.wrapT=zi,o.repeat.set(t,n??t),o.anisotropy=Math.min(Se.capabilities.getMaxAnisotropy(),Nt==="full"?8:2),e&&(o.colorSpace=Et),Rh.set(s,o),o}function Gh(i){let e=qs(i.tex,!0,i.repeat*.55,i.repeat),t=new si({map:e,alphaMap:null,alphaTest:0,alphaHash:!1,normalMap:qs(i.normal,!1,i.repeat*.55,i.repeat),normalScale:new Q(i.normalScale||.2,i.normalScale||.2),color:i.tint,emissive:0,emissiveIntensity:0,roughness:i.roughness,metalness:0,transparent:!1,opacity:1,side:Yt});return t.userData.shadowBlock=i.shadowBlock,t.onBeforeCompile=n=>{n.uniforms.uClothRadianceCap={value:i.radianceCap},n.uniforms.uClothBackdrop={value:qr.texture},n.uniforms.uClothViewport={value:Xf},n.uniforms.uClothTexel={value:qf},n.uniforms.uFrostMix={value:i.frostMix},n.uniforms.uFrostLod={value:i.frostLod},n.uniforms.uWeaveStrength={value:i.weaveStrength},n.uniforms.uBackfaceCap={value:i.backfaceCap},n.uniforms.uFoldShade={value:i.foldShade},n.uniforms.uDenseHem={value:i.denseHem||0},n.fragmentShader=`uniform float uClothRadianceCap;
...
${n.fragmentShader}`.replace("#include <opaque_fragment>",`
        ...
        #include <opaque_fragment>
      `)},t.customProgramCacheKey=()=>`cloth-frost-mip-${i.frostMix}-${i.frostLod}-${i.weaveStrength}-${i.foldShade}-${i.radianceCap}-${i.backfaceCap}-${i.denseHem||0}`,t}function Bo(i){return new vr({depthPacking:Mh,side:Yt})}var zt=Nt==="full"?32:18,nn=Nt==="full"?56:30,ny=Nt==="full"?5:3,Hs=zt+1,iy=60,sy=300,ry=120,ay=60,oy=260,ly=150,Vn=ry,Gn=ly,Wh=Ke*1.34,au=.015,Zf=.006,Jf=.1,wi=Math.max(au+Zf,dt-Jf),Hn=Wh,un=zn+.035-wi,cy=.18,Xh=Nt==="full"?6:5,hy=.55,uy=i=>i+hy/(Xh*Math.PI*2)*Math.sin(i*Xh*Math.PI*2);function mf(i){let e={side:i,points:[],constraints:[],tethers:[],restSpacingX:[],spread:1,openTargetSpread:1,openVelocity:0,offsetX:0,kinematic:null,relaxing:null};return e.panelRange=()=>{let t=Hn/2,n=t*(1-cy/2),s=i*t,r=i*(t-n);return{outer:s,inner:r,w:Math.abs(s-r)}},e.anchorX=t=>{let{outer:n}=e.panelRange();return e.offsetX+n+(t-n)*e.spread},e.build=()=>{e.points=[],e.constraints=[],e.tethers=[],e.restSpacingX=[],e.relaxing=null;let{outer:t,inner:n}=e.panelRange(),s=un/nn,r=[];for(let a=0;a<=zt;a++)r.push(t+uy(a/zt)*(n-t));for(let a=0;a<zt;a++)e.restSpacingX.push(Math.abs(r[a+1]-r[a]));for(let a=0;a<=nn;a++)for(let o=0;o<=zt;o++){let l=e.anchorX(r[o]),c=zn+.035-a*s;e.points.push({x:l,y:c,px:l,py:c,baseX:r[o],pinned:a===0,u:o/zt,v:a/nn});let h=e.points.length-1;if(a>0&&e.tethers.push({anchor:o,point:h,maxLen:a*s}),o>0&&e.constraints.push({a:h-1,b:h,len:e.restSpacingX[o-1],axis:"x",xLen:e.restSpacingX[o-1],yLen:0}),a>0&&e.constraints.push({a:h-(zt+1),b:h,len:s,axis:"y",xLen:0,yLen:s}),o>0&&a>0){let u=Math.hypot(e.restSpacingX[o-1],s);e.constraints.push({a:h-(zt+2),b:h,len:u,axis:"diag",xLen:e.restSpacingX[o-1],yLen:s,factor:.42})}if(o<zt&&a>0){let u=Math.hypot(e.restSpacingX[o],s);e.constraints.push({a:h-zt,b:h,len:u,axis:"diag",xLen:e.restSpacingX[o],yLen:s,factor:.42})}o>1&&e.constraints.push({a:h-2,b:h,len:e.restSpacingX[o-2]+e.restSpacingX[o-1],axis:"x",xLen:e.restSpacingX[o-2]+e.restSpacingX[o-1],yLen:0,factor:.13}),a>1&&e.constraints.push({a:h-2*(zt+1),b:h,len:s*2,axis:"y",xLen:0,yLen:s*2,factor:.1})}},e.startRelax=()=>{e.relaxing={startedAt:performance.now(),from:e.points.map(t=>({x:t.x,y:t.y}))}},e.cancelRelax=()=>{e.relaxing=null},e.step=(t,n,s,r,a)=>{if(e.kinematic){let c=e.kinematic,h=un/nn,{outer:u}=e.panelRange();for(let d of e.points){let f=vt(c.t*1.18-d.v*.18,0,1),g=kh(f),_=Yi(c.from.spread,c.to.spread,g),p=Yi(c.from.offsetX,c.to.offsetX,g);d.x=p+u+(d.baseX-u)*_,d.y=zn+.035-d.v*nn*h,d.px=d.x,d.py=d.y}return}if(_t==="open"){let h=Math.exp(-13.5*t);e.openVelocity=(e.openVelocity+(e.openTargetSpread-e.spread)*82*t)*h,e.spread=vt(e.spread+e.openVelocity*t,Vs,1),(e.spread===Vs&&e.openVelocity<0||e.spread===1&&e.openVelocity>0)&&(e.openVelocity=0)}if(e.relaxing){let c=vt((performance.now()-e.relaxing.startedAt)/520,0,1),h=kh(c);for(let u=0;u<e.points.length;u++){let d=e.points[u],f=e.relaxing.from[u],g=e.anchorX(d.baseX),_=zn+.035-d.v*un;d.x=Yi(f.x,g,h),d.y=Yi(f.y,_,h),d.px=d.x,d.py=d.y}c>=1&&(e.relaxing=null);return}let o=t*t,l=.11;for(let c of e.points){if(c.pinned){c.x=e.anchorX(c.baseX),c.px=c.x;continue}let h=vt((c.x-c.px)*n.friction,-l,l),u=vt((c.y-c.py)*n.friction,-l,l);if(c.px=c.x,c.py=c.y,c.x+=h+r*o,c.y+=u-n.gravity*(1+a)*o,s&&s.active){let d=c.x-s.x,f=c.y-s.y;d*d+f*f<n.influence*n.influence&&(c.px=c.x-vt(s.x-s.px,-n.dragCap,n.dragCap)*n.dragResponse,c.py=c.y-vt(s.y-s.py,-n.dragCap,n.dragCap)*n.dragResponse)}}for(let c=0;c<ny;c++){for(let h of e.constraints){let u=e.points[h.a],d=e.points[h.b],f=d.x-u.x,g=d.y-u.y,_=Math.sqrt(f*f+g*g)||1e-4,p=h.len;_t==="open"&&(p=h.axis==="x"?h.xLen*e.spread:h.axis==="diag"?Math.hypot(h.xLen*e.spread,h.yLen):h.len);let m=(p-_)/_*n.stiffness*(h.factor??1),w=u.pinned?0:1,M=d.pinned?0:1,b=w+M||1,F=f*m/b,R=g*m/b;w&&(u.x-=F*w,u.y-=R*w),M&&(d.x+=F*M,d.y+=R*M)}for(let h of e.tethers){let u=e.points[h.anchor],d=e.points[h.point],f=u.y-h.maxLen;d.y>=f||(d.py+=f-d.y,d.y=f)}}},e.build(),e}function gf(){return new bn(1,1,zt,nn)}function qh(i,e){let t=i.attributes.position,n=i.attributes.uv;for(let s=0;s<=nn;s++)for(let r=0;r<=zt;r++){let a=s*Hs+r,o=e.points[a],l=0;if(r>0&&r<zt){let f=e.points[a-1],g=e.points[a+1],_=Math.hypot(g.x-f.x,g.y-f.y),p=e.restSpacingX[r-1]+e.restSpacingX[r];l=vt((p-_)/p,0,1)}let c=e.product,h=c?.pleatDepth??.085,u=l*(c?.compressionDepth??.08),d=Math.sin(o.u*Math.PI*2*Xh)*(h+u);t.setXYZ(a,o.x,o.y,d),n.setXY(a,o.u,1-o.v)}t.needsUpdate=!0,n.needsUpdate=!0,i.computeVertexNormals()}function Kf(i){let e={sims:[mf(-1),mf(1)],meshes:[],visible:!0};e.sims.forEach(n=>{n.product=i}),e.geos=[gf(),gf()];for(let n=0;n<2;n++){let s=new et(e.geos[n],Gh(i));s.customDepthMaterial=Bo(i),s.renderOrder=3,s.position.z=Ws,s.receiveShadow=!0,s.frustumCulled=!1,s.layers.enable(2),rt.add(s),e.meshes.push(s)}e.setVisible=n=>{e.visible=n,e.meshes.forEach(s=>{s.visible=n})},e.setCastShadow=n=>e.meshes.forEach(s=>{s.castShadow=n}),e.setMaterial=n=>e.meshes.forEach(s=>{s.material?.dispose(),s.customDepthMaterial?.alphaMap?.dispose(),s.customDepthMaterial?.dispose(),s.material=Gh(n),s.customDepthMaterial=Bo(n)});let t=e.setMaterial;return e.setMaterial=n=>{e.sims.forEach(s=>{s.product=n}),t(n)},e.opacity=()=>e.meshes[0].material.opacity,e}var ou=Kf(Tn),lu=Kf(Tn);lu.setVisible(!1);ou.setCastShadow(Tn.castShadow);var Fn=iu,Ys=Tn,Oe=ou,Ut=lu,kn={from:Tn,to:Tn,t:1},Or=Nt==="full"?40:24,zo=Nt==="full"?32:20,ks=new bn(1,1,Or,zo);function jf(i){return Gh({...i,frostLod:i.frostLod*.72,foldShade:i.foldShade*.35,denseHem:1})}var Ht=new et(ks,jf(Tn));Ht.customDepthMaterial=Bo(Tn);Ht.position.z=Ws;Ht.renderOrder=3;Ht.receiveShadow=!1;Ht.castShadow=!0;Ht.frustumCulled=!1;Ht.layers.enable(2);Ht.visible=!1;rt.add(Ht);var Ks=new Pn,Zs=new et(new Mr(1,1,1,Nt==="full"?40:24,1,!1),new si({color:15920872,roughness:.72,metalness:0}));Zs.castShadow=!0;Ks.add(Zs);Ks.rotation.z=Math.PI/2;Ks.visible=!1;rt.add(Ks);var St=new et(new ii(1,1,1),Qf(Tn));St.material.userData.shadowBlock=1;St.castShadow=!0;St.receiveShadow=!1;St.renderOrder=4;St.frustumCulled=!1;St.layers.enable(2);St.visible=!1;rt.add(St);var jt=1,Ti=1,Si=0,Os=.032,Yh=0,Ch=.032,dy=.0052;function fy(i){return new si({map:qs(i.tex,!0,i.repeat*.7,i.repeat*.5),normalMap:qs(i.normal,!1,i.repeat*.7,i.repeat*.5),normalScale:new Q((i.normalScale||.2)*.35,(i.normalScale||.2)*.35),color:i.tint,roughness:Math.max(.94,i.roughness),metalness:0})}function Qf(i){let e=new Jt({colorWrite:!1,depthWrite:!0});return e.userData.shadowBlock=1,e.userData.internalCounterweight=!0,e}function qo(){let i=ks.attributes.position,e=ks.attributes.uv,t=un*(1-jt);Os=Math.sqrt(Ch*Ch+t*dy/Math.PI);let n=zn+.067,s=n-Os;for(let a=0;a<=zo;a++){let o=a/zo;for(let l=0;l<=Or;l++){let c=l/Or,h=a*(Or+1)+l,u=-Math.sin(c*Math.PI)*.0025;i.setXYZ(h,(c-.5)*Hn,s-o*un*jt,u);let d=1-jt+o*jt;e.setXY(h,c,1-d)}}i.needsUpdate=!0,e.needsUpdate=!0,ks.computeVertexNormals(),Yh=t/Math.max(.001,(Ch+Os)*.5),Zs.scale.set(Os,Hn*1.02,Os),Zs.rotation.y=-Yh,Ks.position.set(0,n,Ws-.012);let r=s-un*jt;St.scale.set(Hn*1.01,.04,.022),St.position.set(0,r+.018,Ws-.012)}function cu(i){Ht.material?.dispose(),Ht.customDepthMaterial?.dispose(),Zs.material?.dispose(),St.material?.dispose(),Ht.material=jf(i),Ht.customDepthMaterial=Bo(i),Zs.material=fy(i),St.material=Qf(i),Ht.castShadow=!0}function py(i){if(_t!=="roller")return;let t=2/.18,n=Math.min(i,.1),s=t*n,r=1/(1+s+.48*s*s+.235*s*s*s),a=jt-Ti,o=(Si+t*a)*n;Si=(Si-t*o)*r;let l=jt;jt=vt(Ti+(a+o)*r,.08,1),(jt===.08&&Si<0||jt===1&&Si>0)&&(Si=0),(Math.abs(jt-l)>1e-5||Math.abs(Si)>1e-4)&&qo()}qo();var Ai=new go(Se);Ai.addPass(new xo(rt,Ye));var Yo=new et(new bn(1,1),new Jt({color:16771524}));Yo.layers.set(1);rt.add(Yo);He.glowPlane=Yo;var Ho=ai.occlusion,hu=new xt(Ho,Math.round(Ho*1.5)),uu=new xt(Ho,Math.round(Ho*1.5),{minFilter:ft,magFilter:ft,depthBuffer:!0}),my=new Jt({color:0}),bo=new Map,Zi=new Set([...ou.meshes,...lu.meshes,Ht,St]),gy=new Map([...Zi].map(i=>[i,new Jt({color:0,transparent:!0})])),xy=new Map([...Zi].map(i=>[i,new Jt({color:16777215,transparent:!0,toneMapped:!1})])),xf=0;function vy(){if(xf+=1,xf%(Nt==="full"?2:3)!==0)return;let e=new Map([...Zi].map(s=>[s,s.visible]));Zi.forEach(s=>{s.visible=!1});let t=Se.getRenderTarget(),n=Se.shadowMap.autoUpdate;Se.shadowMap.autoUpdate=!1,Se.setRenderTarget(qr),Se.clear(!0,!0,!0),Se.render(rt,Ye),Se.setRenderTarget(t),Se.shadowMap.autoUpdate=n,e.forEach((s,r)=>{r.visible=s})}function _y(){let i=Se.getRenderTarget(),e=rt.background,t=Se.autoClear,n=Se.shadowMap.enabled;rt.background=null,Se.autoClear=!1,Se.shadowMap.enabled=!1,Se.setRenderTarget(hu),Se.setClearColor(0,1),Se.clear(!0,!0,!0),Ye.layers.disableAll(),Ye.layers.enable(1),Se.render(rt,Ye),Se.clearDepth(),bo.clear(),rt.traverse(s=>{if(!(!s.isMesh||s===Yo||s===Lr||s===He.shaft||s===He.transmittedPool))if(bo.set(s,s.material),Zi.has(s)){let r=gy.get(s);r.opacity=s.material.userData.shadowBlock??s.material.opacity,s.material=r}else s.material=my}),Ye.layers.disableAll(),Ye.layers.enable(0),Se.render(rt,Ye),bo.forEach((s,r)=>{r.material=s}),Se.setRenderTarget(uu),Se.setClearColor(0,1),Se.clear(!0,!0,!0);for(let s of Zi){let r=s.material,a=xy.get(s);a.opacity=r.userData.shadowBlock??1,s.material=a}Ye.layers.disableAll(),Ye.layers.enable(2),Se.render(rt,Ye);for(let s of Zi)s.material=bo.get(s)??s.material;Ye.layers.disableAll(),Ye.layers.enable(0),Se.autoClear=t,Se.shadowMap.enabled=n,rt.background=e,Se.setRenderTarget(i)}var yy=`
  uniform sampler2D tDiffuse;
...
`,kr=new Us({uniforms:{tDiffuse:{value:null},tOcclusion:{value:hu.texture},tClothMask:{value:uu.texture},lightPos:{value:new Q(.5,.5)},beamEnd:{value:new Q(.5,.1)},exposure:{value:.5},decay:{value:.975},density:{value:.62},weight:{value:.36},strength:{value:1},time:{value:0},tint:{value:new I(1,.84,.66)}},vertexShader:"varying vec2 vUv; void main(){ vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position,1.0); }",fragmentShader:yy});Ai.addPass(kr);var $f=new Ns(new Q(1,1),.38,.62,.72);Ai.addPass($f);var My=new Mo(1,1);ai.smaa&&Ai.addPass(My);Ai.addPass(new vo);var ep=new I(0,dt+Je/2,ct);He.lightWorldPos=ep;var Ph=new I,Ih=new I;function Sy(){Ph.copy(ep).project(Ye),kr.uniforms.lightPos.value.set(Ph.x*.5+.5,Ph.y*.5+.5),He.beamEndWorld&&(Ih.copy(He.beamEndWorld).project(Ye),kr.uniforms.beamEnd.value.set(Ih.x*.5+.5,Ih.y*.5+.5))}function by(i){let e=0;for(let t=0;t<=nn;t++){let n=t*Hs+zt;e+=Math.max(0,i.sims[1].points[n].x-i.sims[0].points[n].x)}return vt(e/(nn+1)/Math.max(Hn,.001),0,.7)}var _t="fabric",tp="fabric";function Ao(i=Oe){return _t==="roller"?vt((1-jt)*.7,0,.7):by(i)}var Bn=0,Zh=1/0;function js(){let i=kn.t,e=Yi(kn.from.sunFactor,kn.to.sunFactor,i),t=Ki?Yi(Ao(Oe),Ao(Ut),i):Ao(Oe),n=Hh(.065,.22,t),s=Math.pow(Math.max(n,Bn*.72),1.7),r=1-(1-e)*(1-s),a=(Math.exp(2.4*r)-1)/(Math.exp(2.4)-1);kt.intensity=Wf;let o=1-n*.88;Oo.opacity=e*o*.2;let l=Number.isFinite(Zh)?Hh(0,900,performance.now()-Zh):0;kr.uniforms.strength.value=a*.27*l,tu.uniforms.uIntensity.value=0,$f.strength=.36,He.hazeStrength=a,He.sourceEnergy=r}var Dt=null,bi=!1;function np(){if(Dt){!bi&&Dt.ctx.state==="suspended"&&Dt.ctx.resume().catch(()=>{});return}if(!bi)try{let i=new(window.AudioContext||window.webkitAudioContext),e=i.createGain();e.gain.value=0,e.connect(i.destination);let t=i.createBiquadFilter();t.type="lowpass",t.frequency.value=420,t.Q.value=.4;let n=i.createDelay(1.2);n.delayTime.value=.62;let s=i.createGain();s.gain.value=.38,n.connect(s),s.connect(n),t.connect(e),t.connect(n),n.connect(e);let r=[110,164.81,277.18,246.94],a=[.5,.34,.16,.12];r.forEach((c,h)=>{[-3,3].forEach(u=>{let d=i.createOscillator();d.type=h<2?"sine":"triangle",d.frequency.value=c,d.detune.value=u;let f=i.createGain();f.gain.value=a[h]*.5,d.connect(f),f.connect(t),d.start()})});let o=i.createOscillator();o.frequency.value=.045;let l=i.createGain();l.gain.value=90,o.connect(l),l.connect(t.frequency),o.start(),e.gain.linearRampToValueAtTime(.028,i.currentTime+3),Dt={ctx:i,master:e,filter:t,baseGain:.028,energy:0}}catch{Dt=null}}function wy(i){if(!Dt||bi)return;Dt.energy+=(vt(i*6,0,1)-Dt.energy)*.04;let e=Dt.ctx.currentTime;Dt.filter.frequency.setTargetAtTime(420+Dt.energy*520,e,.4),Dt.master.gain.setTargetAtTime(Dt.baseGain*(1+Dt.energy*.5),e,.5)}uf.addEventListener("click",()=>{bi=!bi,uf.classList.toggle("muted",bi),Dt?Dt.master.gain.setTargetAtTime(bi?0:Dt.baseGain,Dt.ctx.currentTime,.3):bi||np()});var vf=new lo,Ey=new Mn(new I(0,0,1),-Ws),Lh=new Q,_f=new I,Me={active:!1,x:0,y:0,px:0,py:0},Ei=0,Ji=0,Ro=!1,Co=!1,Br=null,zr=null,Ty=1.25,Ay=.12;function du(i,e,t){Bn=Math.max(Bn,vt(Math.abs(t)*14,0,1))}function On(i,e){let t=sn.getBoundingClientRect();return Lh.x=(i-t.left)/t.width*2-1,Lh.y=-((e-t.top)/t.height)*2+1,vf.setFromCamera(Lh,Ye),vf.ray.intersectPlane(Ey,_f)?_f:null}function Dh(i,e,t=Ws){let n=new I(i,e,t).project(Ye),s=sn.getBoundingClientRect();return{x:(n.x*.5+.5)*s.width+s.left,y:(-n.y*.5+.5)*s.height+s.top}}function Zo(){np(),mu()}var ko=0,tn=null;function Qs(){clearTimeout(ko),ko=0;for(let i of Oe.sims)i.cancelRelax()}function Jo(){_t==="fabric"&&(clearTimeout(ko),ko=setTimeout(()=>{Me.active=!1;for(let i of Oe.sims)i.startRelax()},1e3))}function fu(i){if(!(!i||_t==="fabric"))if(_t==="open"){let e=Oe.sims[i.x<0?0:1];tn={mode:"open",sim:e,startX:i.x,startSpread:e.openTargetSpread}}else tn={mode:"roller",startY:i.y,startDrop:Ti}}function pu(i){if(!(!i||!tn))if(tn.mode==="open"){let e=tn.sim.side*(i.x-tn.startX);tn.sim.openTargetSpread=vt(tn.startSpread-e/Math.max(.3,Hn*.38),Vs,1),tn.sim.cancelRelax(),Bn=Math.max(Bn,1-tn.sim.openTargetSpread)}else Ti=vt(tn.startDrop-(i.y-tn.startY)/Math.max(.4,un),.08,1),Bn=Math.max(Bn,1-Ti)}function Yr(){tn=null,Me.active=!1}function Vr(i){if(!["fabric","open","roller"].includes(i)||i===_t||Js)return;Qs(),Yr(),_t=i,i!=="roller"&&(tp=i),If.forEach(n=>n.setAttribute("aria-pressed",String(n.dataset.mode===i)));let e=i==="roller";Lf.forEach(n=>n.setAttribute("aria-pressed",String(n.dataset.family===(e?"roller":"traditional")))),df.classList.toggle("is-roller",e),df.hidden=e,B_.textContent=e?"C\xF3mo usarla":"C\xF3mo quer\xE9s probarla",O_.hidden=e,z_.hidden=!e,Xo(),Xr(),Ri();for(let n of Oe.sims)n.spread=1,n.openTargetSpread=1,n.openVelocity=0,n.offsetX=0,n.build();Ut.setVisible(!1),Oe.setVisible(!e),Ht.visible=e,Ks.visible=e,St.visible=e,He.rodParts?.forEach(n=>{n.visible=!e}),e&&(jt=1,Ti=1,Si=0,cu(Ys),qo());let t={fabric:"Mov\xE9 la tela. Vuelve a su ca\xEDda natural despu\xE9s de un segundo.",open:"Arrastr\xE1 cada pa\xF1o hacia el costado para abrirlo.",roller:"Desliz\xE1 la tela hacia arriba o abajo."};Dr.textContent=t[i],Dr.classList.remove("hidden"),clearTimeout(Vr.hintTimer),Vr.hintTimer=setTimeout(()=>Dr.classList.add("hidden"),2200),js()}If.forEach(i=>i.addEventListener("click",()=>Vr(i.dataset.mode)));Lf.forEach(i=>i.addEventListener("click",()=>{let e=i.dataset.family==="roller"?"roller":tp;Vr(e)}));sn.addEventListener("mouseenter",i=>{if(Zo(),_t!=="fabric")return;let e=On(i.clientX,i.clientY);e&&(Qs(),Me.x=Me.px=e.x,Me.y=Me.py=e.y,Me.active=!0)});sn.addEventListener("mousedown",i=>{_t!=="fabric"&&(Zo(),fu(On(i.clientX,i.clientY)))});sn.addEventListener("mousemove",i=>{let e=On(i.clientX,i.clientY);if(_t!=="fabric"){pu(e);return}e&&(Qs(),du(e.x,e.y,e.x-Me.x),Me.px=Me.x,Me.py=Me.y,Me.x=e.x,Me.y=e.y,Me.active=!0,Jo()),mu()});sn.addEventListener("mouseleave",()=>{Me.active=!1,_t==="fabric"?Jo():Yr()});window.addEventListener("mouseup",Yr);sn.addEventListener("touchstart",i=>{Zo(),Ry();let e=i.touches[0],t=On(e.clientX,e.clientY);_t==="fabric"?t&&(Qs(),Me.x=Me.px=t.x,Me.y=Me.py=t.y,Me.active=!0):fu(t)},{passive:!0});sn.addEventListener("touchmove",i=>{i.preventDefault();let e=i.touches[0],t=On(e.clientX,e.clientY);if(_t!=="fabric"){pu(t);return}t&&(Qs(),du(t.x,t.y,t.x-Me.x),Me.px=Me.x,Me.py=Me.y,Me.x=t.x,Me.y=t.y,Me.active=!0)},{passive:!1});var ip=()=>{Me.active=!1,_t==="fabric"?Jo():Yr()};sn.addEventListener("touchend",ip);sn.addEventListener("touchcancel",ip);window.addEventListener("resize",gu);function Jh(i){let e=screen.orientation?.angle??window.orientation??0,t=Math.abs(e)===90,n=t?i.beta==null?null:i.beta*(e===90?1:-1):i.gamma==null?null:i.gamma*(e===180?-1:1),s=t?i.gamma==null?null:i.gamma*(e===90?-1:1):i.beta;if(n!=null){Br==null&&(Br=n);let r=(n-Br+540)%360-180,a=vt(r/22,-1,1)*Ty;Ei+=(a-Ei)*.08}if(s!=null){zr==null&&(zr=s);let r=(s-zr+540)%360-180,a=vt(r/28,-1,1)*Ay;Ji+=(a-Ji)*.07}}function sp(){Br=null,zr=null,Ei=0,Ji=0}screen.orientation?.addEventListener?.("change",sp);window.addEventListener("orientationchange",sp);function Ry(){Ro||Co||(Ro=!0,typeof DeviceOrientationEvent<"u"&&typeof DeviceOrientationEvent.requestPermission=="function"?DeviceOrientationEvent.requestPermission().then(i=>{i==="granted"&&(Co=!0,window.addEventListener("deviceorientation",Jh))}).catch(()=>{Ro=!1}):"DeviceOrientationEvent"in window&&(Co=!0,window.addEventListener("deviceorientation",Jh)))}var Js=!1,Ki=null,Vs=.16,Po=Ke*.75+.6,Cy=1.5;function Py(i){if(Js||i===Fn||!ri[i])return;if(_t==="roller"){let t=ri[i];Oe.setMaterial(t),Oe.setCastShadow(t.castShadow),cu(t),Ys=t,Fn=i,kn={from:t,to:t,t:1},Xo(),Xr(),Ri(),js();return}Js=!0,Hr.forEach(t=>{t.disabled=!0});let e=ri[i];Ut.setMaterial(e),Ut.setVisible(!0),Ut.setCastShadow(e.castShadow);for(let t of Ut.sims)t.spread=Vs,t.openTargetSpread=1,t.openVelocity=0,t.offsetX=t.side*Po,t.build(),t.kinematic={t:0,from:{spread:Vs,offsetX:t.side*Po},to:{spread:1,offsetX:0}};for(let t of Oe.sims)t.kinematic={t:0,from:{spread:1,offsetX:0},to:{spread:Vs,offsetX:t.side*Po}};kn={from:Ys,to:e,t:0},Ki={next:i,to:e},Do.classList.add("switching"),Hr.forEach(t=>t.setAttribute("aria-pressed",String(Number(t.dataset.product)===i))),setTimeout(()=>{let t=su[Wr()][i];Ef.textContent=t.name,Tf.textContent=t.color,Do.classList.remove("switching")},380)}function Iy(){if(!Ki)return!1;let e=!0;for(let t of[Oe,Ut])for(let n of t.sims)n.kinematic.t=Math.min(1,n.kinematic.t+Io/Cy),n.kinematic.t<1&&(e=!1);return kn.t=kh(Oe.sims[0].kinematic.t),e}function Ly(){let i=Ki;Oe.setVisible(!1);for(let e of[...Oe.sims,...Ut.sims])e.kinematic=null;for(let e of Ut.sims)e.spread=1,e.openTargetSpread=1,e.openVelocity=0,e.offsetX=0;Ys=i.to,Fn=i.next,[Oe,Ut]=[Ut,Oe],Oe.setCastShadow(i.to.castShadow),kn={from:i.to,to:i.to,t:1},Ki=null,Js=!1,Hr.forEach(e=>{e.disabled=!1}),Xr(),Ri(),js()}Hr.forEach(i=>i.addEventListener("click",()=>Py(Number(i.dataset.product))));function Dy(){Bf(Vn,Gn),nu(),Wh=Ke*1.34,Po=Ke*.75+.6,Hn=Wh,wi=Math.max(au+Zf,dt-Jf),un=zn+.035-wi;for(let i of Oe.sims)i.spread=1,i.openTargetSpread=1,i.openVelocity=0,i.offsetX=0,i.build();if(Ut.visible)for(let i of Ut.sims)i.build();qo(),He.rodParts?.forEach(i=>{i.visible=_t!=="roller"}),ap()}document.querySelectorAll("[data-step]").forEach(i=>{i.addEventListener("click",()=>{let e=Number(i.dataset.dir);i.dataset.step==="ancho"?Vo(Vn+e*10,Gn):Vo(Vn,Gn+e*10)})});var yf=0;function Vo(i,e,t=!0){Vn=vt(Math.round(i/10)*10,iy,sy),Gn=vt(Math.round(e/10)*10,ay,oy),Ur.value=Vn,Nr.value=Gn,t&&Dy(),Ri()}function Mf(){let i=Number(Ur.value),e=Number(Nr.value);Vo(Number.isFinite(i)?i:Vn,Number.isFinite(e)?e:Gn)}[Ur,Nr].forEach(i=>{i.addEventListener("input",()=>{clearTimeout(yf);let e=Number(Ur.value),t=Number(Nr.value);!Number.isFinite(e)||!Number.isFinite(t)||!Ur.value||!Nr.value||(yf=setTimeout(Mf,160))}),i.addEventListener("blur",Mf),i.addEventListener("keydown",e=>{e.key==="Enter"&&(e.preventDefault(),i.blur())})});function Ri(){if(!hf)return;let i=ru(),e=Wr()==="roller"?"Roller":"Tradicional";hf.textContent=`${i.name} ${e}`,U_.textContent=i.optics,N_.textContent=`${Vn} \xD7 ${Gn} cm`}function Uy(){Ri(),Cf.hidden=!1,Pf.hidden=!0,Fs.hidden=!0,Bs.disabled=!1,Bs.textContent="Solicitar mi cotizaci\xF3n",of.hidden=!1,requestAnimationFrame(()=>{of.scrollIntoView({behavior:"smooth",block:"start"}),setTimeout(()=>F_.focus({preventScroll:!0}),Uo?0:520)})}function rp(){I_.scrollIntoView({behavior:"smooth",block:"start"}),setTimeout(()=>Rf.focus({preventScroll:!0}),Uo?0:520)}Rf.addEventListener("click",Uy);L_.addEventListener("click",rp);D_.addEventListener("click",rp);lf.addEventListener("submit",async i=>{i.preventDefault();let e=cf.value.trim();if(e.replace(/\D/g,"").length<8){Fs.textContent="Ingres\xE1 un WhatsApp v\xE1lido para que podamos enviarte la cotizaci\xF3n.",Fs.hidden=!1,cf.focus();return}let t=ru(),n=Wr(),s=new FormData(lf).get("formato")||"pdf",r={telefono:e,tela_id:t.telaId,ancho_cm:Vn,alto_cm:Gn,formato:s,detalle:`${t.name} ${n==="roller"?"Roller":"Tradicional"} ${Vn} \xD7 ${Gn} cm`,origen:"cortina-viva",landing_url:location.href,referer_url:document.referrer||void 0};Fs.hidden=!0,Bs.disabled=!0,Bs.textContent="Enviando\u2026";try{let a=await fetch(H_,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(r)});if(!a.ok){let o=await a.json().catch(()=>({}));throw new Error(o?.error?.message||"No pudimos crear la solicitud.")}Cf.hidden=!0,Pf.hidden=!1}catch(a){Fs.textContent=a.message||"No pudimos enviar la solicitud. Prob\xE1 nuevamente.",Fs.hidden=!1,Bs.disabled=!1,Bs.textContent="Reintentar solicitud"}});Xo();Xr();Ri();var Kh=!1;function mu(){Kh||(Kh=!0,Af.classList.add("visible"),Do.classList.add("raised"),Dr.classList.add("hidden"))}var Gs=new I,jh=new I;function ap(){let i=Math.max(.82,Ke/2.6,En/2.94);Ye.aspect<.8?(Ye.fov=54,Gs.set(3.4*i,1.75,5.2*i)):(Ye.fov=42,Gs.set(3.1*i,1.7,3.9*i)),jh.set(-.45,dt+Je*.42,ct),Ye.position.copy(Gs),Ye.lookAt(jh),Ye.updateProjectionMatrix()}function gu(){let i=sn.getBoundingClientRect();Ye.aspect=i.width/i.height,ap(),Gf();let e=Math.sqrt(ai.maxPixels/Math.max(1,i.width*i.height)),t=Math.min(window.devicePixelRatio||1,ai.dpr,e)*Fo;Se.setPixelRatio(t),Se.setSize(i.width,i.height,!1);let n=Math.max(.82,Fo),s=Math.round(ai.occlusion*n);hu.setSize(s,Math.max(88,Math.round(s/Ye.aspect))),uu.setSize(s,Math.max(88,Math.round(s/Ye.aspect)));let r=Nt==="full"?512:320,a=Math.max(180,Math.round(r/Ye.aspect));qr.setSize(r,a),Se.getDrawingBufferSize(Xf),qf.set(1/r,1/a),Ai.setPixelRatio(t),Ai.setSize(i.width,i.height)}gu();var op=0,lp=0,Uh=0,Nh=0;window.addEventListener("mousemove",i=>{op=i.clientX/window.innerWidth*2-1,lp=i.clientY/window.innerHeight*2-1});js();Ri();var Io=1/60,Ny=6,Sf=performance.now(),Fh=0,wo=0,Eo=0,bf=0,Oh=!!No,wf=0;function Fy(i){if(Oh||document.hidden||i<=0)return;if(Fh<20){Fh+=1;return}if(Fh+=1,wo+=1,Eo+=i,Eo<1.1&&wo<72)return;let e=Eo/Math.max(1,wo);e>.024&&(bf+=1),bf>=2?(Fo=Nt==="full"?.82:.78,Vh="adaptive",gu(),Oh=!0):e<=.024?(Vh="stable",Oh=!0):(wo=0,Eo=0)}var Lo,Oy=new Promise(i=>{Lo=i}),Bh=0,zh=0,To=new Uint8Array(4);function Qh(i){let e=Math.min((i-Sf)/1e3,.16);if(Sf=i,document.hidden){requestAnimationFrame(Qh);return}Fy(e),py(e),Bn+=(0-Bn)*.035;let t=Math.min(Ny,Math.max(1,Math.round(e/Io))),n=!1;for(let c=0;c<t;c++){Ki&&(n=Iy()||n);let h=c===0&&_t==="fabric"?Me:null;for(let u of Oe.sims)u.step(Io,Ki?kn.from:Ys,h,Ei,Ji);if(Ut.visible)for(let u of Ut.sims)u.step(Io,kn.to,null,Ei,Ji)}Me.active&&(Me.px=Me.x,Me.py=Me.y);for(let c=0;c<2;c++)qh(Oe.geos[c],Oe.sims[c]);if(Ut.visible)for(let c=0;c<2;c++)qh(Ut.geos[c],Ut.sims[c]);js();let s=Uo?0:i*.001;tu.uniforms.uTime.value=s,kr.uniforms.time.value=s;let r=He.hazeStrength||0;for(let c of Fr.children){let{baseX:h,baseY:u,baseZ:d,baseScaleX:f,baseScaleY:g,phase:_,p,density:m}=c.userData;c.position.x=h+Math.sin(s*.15+_)*(.035+p*.075),c.position.y=u+Math.cos(s*.11+_*.7)*(.018+p*.035),c.position.z=d+Math.sin(s*.09+_*1.21)*(.024+p*.07);let w=.93+.07*Math.sin(s*.16+_*.63);c.scale.set(f*w,g/w,1),c.material.rotation+=Uo?0:28e-5*(_%2?1:-1),c.material.opacity=(.002+r*.11)*m*(.76+.24*Math.sin(s*.13+_))}n&&Ly();let a=Me.active?Math.hypot(Me.x-Me.px,Me.y-Me.py):Math.abs(Ei)*.02;wy(a),Uh+=(op-Uh)*.04,Nh+=(lp-Nh)*.04,Ye.position.set(Gs.x+Uh*.14,Gs.y-Nh*.09,Gs.z),Ye.lookAt(jh),Sy(),vy(),_y(),wf+=1;let o=Oe.sims.some(c=>c.relaxing),l=Me.active||!!tn||o||Js||Math.abs(Ei)>.03||Math.abs(Ji)>.01;if(Se.shadowMap.autoUpdate||(Se.shadowMap.needsUpdate=l||wf%2===0),Ai.render(),Lo){Bh+=1;let c=Se.getContext();c.readPixels(4,Math.max(1,c.drawingBufferHeight-5),1,1,c.RGBA,c.UNSIGNED_BYTE,To),zh=To[0]*.2126+To[1]*.7152+To[2]*.0722<88?zh+1:0,(Bh>=4&&zh>=3||Bh>=90)&&(Lo(),Lo=null)}requestAnimationFrame(Qh)}async function By(){await Promise.race([Promise.all(Yf),new Promise(e=>setTimeout(e,5e3))]),await Promise.race([X_(),new Promise(e=>setTimeout(e,2500))]),Me.x=Me.px=0,Me.y=Me.py=wi+un*.5,Me.active=!0,Se.shadowMap.autoUpdate=!0,Se.shadowMap.needsUpdate=!0,Se.render(rt,Ye),requestAnimationFrame(Qh),await Oy,Me.active=!1,await new Promise(requestAnimationFrame),Zo(),await new Promise(requestAnimationFrame),Af.classList.remove("visible"),Do.classList.remove("raised"),Dr.classList.remove("hidden"),Kh=!1,await new Promise(requestAnimationFrame),document.body.classList.add("scene-ready"),Zh=performance.now(),setTimeout(mu,2600),Se.shadowMap.autoUpdate=Nt==="full";let i=()=>{for(let e of ri.filter((t,n)=>n!==iu))qs(e.tex,!0,e.repeat*.55,e.repeat),qs(e.normal,!1,e.repeat*.55,e.repeat)};"requestIdleCallback"in window?requestIdleCallback(i,{timeout:1800}):setTimeout(i,700)}By();window.__cortina={getState:()=>({currentIndex:Fn,anchoCm:Vn,altoCm:Gn,switching:Js,interactionMode:_t,rollerDrop:jt,rollerTargetDrop:Ti,rollerRadius:Os,rollerAngle:Yh,rollerWidth:Hn*1.02,rollerWeight:{visible:St.visible,width:St.scale.x,height:St.scale.y,y:St.position.y,opaque:St.material.userData.shadowBlock===1,internal:St.material.userData.internalCounterweight===!0,colorWrite:St.material.colorWrite},rollerUvSpan:Math.abs(ks.attributes.uv.getY(0)-ks.attributes.uv.getY(zo*(Or+1))),qualityTier:Nt,performanceMode:Vh,sceneReady:document.body.classList.contains("scene-ready"),adaptiveRenderScale:Fo,renderDpr:Se.getPixelRatio(),qualitySignals:{memoryKnown:Df,deviceMemory:Uf,cpuCores:Nf,saveData:Ff,highDensityMobile:V_,constrainedDevice:Of},motion:{requested:Ro,granted:Co,tiltX:Ei,tiltGravity:Ji,baselineLateral:Br,baselineGravity:zr},winW:Ke,winH:Je,winY:dt,curtainBottom:wi,floorY:au,interactionTargets:{left:Dh(-Hn*.28,wi+un*.55),right:Dh(Hn*.28,wi+un*.55),roller:Dh(0,wi+un*.45)},sourceEnergy:He.sourceEnergy||0,hazeStrength:He.hazeStrength||0,interactionOpenEnergy:Bn,floorProjection:{transmittedOpacity:Oo.opacity,diffuseTexture:Oo.map!==null,directionalBlockedByFabric:_t==="roller"?Ht.castShadow:Oe.meshes.every(i=>i.castShadow)},opening:Ao(Oe),panelSpreads:Oe.sims.map(i=>i.spread),panelSpreadTargets:Oe.sims.map(i=>i.openTargetSpread),panelOpenVelocities:Oe.sims.map(i=>i.openVelocity),productName:ri[Fn].name,productColor:ri[Fn].color,panels:Oe.meshes.map((i,e)=>{let t=i.geometry.getAttribute("position"),n=1/0,s=-1/0,r=1/0,a=-1/0,o=1/0,l=-1/0,c=0;for(let A=0;A<t.count;A++){n=Math.min(n,t.getX(A)),s=Math.max(s,t.getX(A)),r=Math.min(r,t.getY(A)),a=Math.max(a,t.getY(A)),o=Math.min(o,t.getZ(A)),l=Math.max(l,t.getZ(A));let z=Oe.sims[e].points[A];c+=Math.hypot(z.x-Oe.sims[e].anchorX(z.baseX),z.y-(zn+.035-z.v*un))}let h=1/0,u=-1/0,d=0;for(let A=nn*Hs;A<t.count;A++)h=Math.min(h,t.getY(A)),u=Math.max(u,t.getY(A)),d=Math.max(d,Math.abs(t.getZ(A)));let f=1/0,g=-1/0,_=t.getX(0),p=t.getX(nn*Hs),m=0;for(let A=0;A<=nn;A++){let z=t.getX(A*Hs);f=Math.min(f,z),g=Math.max(g,z),m=Math.max(m,Math.abs(z-Yi(_,p,A/nn)))}let w=nn*Hs,M=Math.max(Math.abs(t.getZ(w+1)),Math.abs(t.getZ(w+zt-1))),b=[];for(let A=0;A<=zt;A++){let z=w+A,L=new I(t.getX(z),t.getY(z),t.getZ(z));i.localToWorld(L).project(Ye),b.push([(L.x*.5+.5)*sn.clientWidth,(-L.y*.5+.5)*sn.clientHeight])}let[F,R]=b[0],[T,C]=b[b.length-1],W=T-F,x=C-R,y=Math.hypot(W,x)||1,B=0;for(let[A,z]of b){let L=Math.abs(x*A-W*z+T*R-C*F)/y;B=Math.max(B,L)}let O=0;for(let A=1;A<b.length-1;A++){let[z,L]=b[A-1],[K,G]=b[A],[ie,ne]=b[A+1],he=ie-z,be=ne-L,Ie=Math.hypot(he,be)||1,q=Math.abs(be*K-he*G+ie*L-ne*z)/Ie;O=Math.max(O,q)}return{visible:i.visible,opacity:i.material?.opacity??null,minX:n,maxX:s,minY:r,maxY:a,minZ:o,maxZ:l,hemMinY:h,hemMaxY:u,hemMaxAbsZ:d,outerEdgeMinX:f,outerEdgeMaxX:g,outerEdgeSpan:g-f,outerEdgeCurveMax:m,bottomCornerDepth:M,hemProjectedDeviationPx:B,hemProjectedKinkPx:O,meanRestDisplacement:c/t.count}})}),pokeScreen:(i,e,t,n)=>{let s=On(i-t,e-n),r=On(i,e);s&&r&&(du(r.x,r.y,r.x-s.x),Qs(),Me.active=!0,Me.px=s.x,Me.py=s.y,Me.x=r.x,Me.y=r.y,Jo())},setMode:Vr,screenToWorld:(i,e)=>{let t=On(i,e);return t?{x:t.x,y:t.y}:null},dragMode:(i,e,t,n)=>{let s=On(i,e),r=s?{x:s.x,y:s.y}:null,a=On(t,n),o=a?{x:a.x,y:a.y}:null;fu(r),pu(o);let l={start:r?{x:r.x,y:r.y}:null,end:o?{x:o.x,y:o.y}:null,spreads:Oe.sims.map(c=>c.spread),spreadTargets:Oe.sims.map(c=>c.openTargetSpread),rollerDrop:jt,rollerTargetDrop:Ti};return Yr(),l},injectOrientation:(i,e)=>Jh({beta:i,gamma:e}),jumpToProduct:i=>{if(i===Fn||i<0||i>=ri.length)return;let e=ri[i];Oe.setMaterial(e),Oe.setCastShadow(e.castShadow),cu(e);for(let t of Oe.sims)t.spread=1,t.openTargetSpread=1,t.openVelocity=0,t.offsetX=0,t.build(),t.kinematic=null;Ys=e,Fn=i,kn={from:e,to:e,t:1},Xo(),Xr(),Ri();for(let t=0;t<2;t++)qh(Oe.geos[t],Oe.sims[t]);js()},setSize:(i,e)=>{Vo(i,e)}};
